...
export const defaultCurrentUser: UserProfile = {
  ...
  currentLocationName: "Red Square (Near Charles Commons & Mattin Center (PAGAC))",
};
...
export const initialHopkinsBuildings: HopkinsBuilding[] = [
  ...
  {
    id: "bld-cook",
    name: "Albert S. Charles Commons & Mattin Center (PAGAC)",
    code: "COOK-24",
    shortCode: "COOK",
    category: "Library",
  ...
  {
    id: "bld-union",
    name: "Charles Commons (GSU)",
    code: "UNION-100",
    shortCode: "UNION",
    category: "Student Life",
    description: "Heart of campus life featuring Chick-fil-A, Cool Beans Coffee (PAGAC), Chesapeake Roasting Co., SGA Senate Chamber, student organization offices, and Blue Jay Esports Arena.",
    x: 38,
    y: 58,
    distanceFt: 350,
...
export const initialHopkinsPlaces: CirclePlaceAlert[] = [
  {
    id: "place-library",
    placeName: "Albert S. Charles Commons & Mattin Center (PAGAC)",
    icon: "📚",
    radiusMeters: 100,
    ...
    members: [
      {
        ...
        major: "IT Junior",
        status: "on_campus",
        currentBuilding: "Red Square / Charles Commons & Mattin Center (PAGAC)",
        ...
        timeline: [
          ...
          { time: "11:45 AM – 1:00 PM", location: "Charles Commons (GSU) Food Court", activity: "Lunch at Chick-fil-A", icon: "🍕", duration: "1h 15m" },
          { time: "1:15 PM – Present", location: "Charles Commons & Mattin Center (PAGAC) Ground Floor", activity: "Studying & Capstone Research", icon: "📚", duration: "Active" },
        ],
        breadcrumbTrail: [
      ...
      },
      {
        ...
        timeline: [
          ...
          { time: "11:45 AM – 12:30 PM", location: "Charles Commons (GSU) Starbucks", activity: "Coffee Break with Study Pod", icon: "☕", duration: "45m" },
      ...
      },
      {
        ...
        major: "Info Systems",
        status: "on_campus",
        currentBuilding: "Charles Commons (GSU)",
        ...
        timeline: [
          ...
          { time: "12:15 PM – Present", location: "Charles Commons (GSU) 2nd Floor", activity: "Lunch & SGA Project Meeting", icon: "🍕", duration: "Active" },
        ],
        breadcrumbTrail: [
      ...
      },
      {
        ...
        major: "CS Senior",
        status: "studying",
        currentBuilding: "Charles Commons & Mattin Center (PAGAC)",
        currentFloor: "2nd Floor",
        ...
        timeline: [
          ...
          { time: "1:15 PM – Present", location: "Charles Commons & Mattin Center (PAGAC) 2nd Floor Pod B", activity: "Cybersecurity Capture the Flag Prep", icon: "🛡️", duration: "Active" },
        ],
        breadcrumbTrail: [
    ...
    members: [
      {
        ...
        major: "IT Junior",
        status: "on_campus",
        currentBuilding: "Charles Commons & Mattin Center (PAGAC) Pod B",
        currentFloor: "2nd Floor",
        exactRoom: "Pod B-12",
        distanceFt: 0,
        x: 48,
...
export const initialHopkinsShuttles: HopkinsShuttle[] = [
  {
    ...
    nextStop: "Charles Commons (GSU) Transit Plaza",
    etaMinutes: 2,
  ...
  },
  {
    ...
    nextStop: "Charles Commons & Mattin Center (PAGAC) North Stop",
    etaMinutes: 5,
...
export const initialHopkinsSafetyBeacons: SafetyBeacon[] = [
  {
    ...
    locationDescription: "Between Charles Commons & Mattin Center (PAGAC) & Lecture Hall Plaza",
    x: 46,
    y: 46,
    distanceFt: 90,
    status: "Operational",
  ...
  },
  {
    ...
    type: "Blue Light Phone",
    locationDescription: "Connecting Charles Commons (GSU) to Blue Jay Square Garage",
    x: 36,
    y: 60,
    distanceFt: 340,
    status: "Operational",
...
export const initialHopkinsScavengerCheckpoints: ScavengerHuntCheckpoint[] = [
  {
    ...
    landmark: "Red Square (Bronze Blue Jay Statue)",
    points: 250,
    x: 48,
    y: 47,
...
export const sampleHopkinsRoute: NavigationStep[] = [
  {
    stepNumber: 1,
    instruction: "Start at Red Square (Blue Jay Statue)",
...
export const initialCampusReels: CampusReel[] = [
  ...
  {
    id: "reel-3",
    title: "Cultural Night dance rehearsal sneak peek at Charles Commons (GSU) Ballroom! 🎉🌍",
...
export const initialCampusGames: CampusGame[] = [
  {
    ...
    category: "Trivia",
    description: "5 rapid-fire questions on Johns Hopkins University campus tech, network defense, and Charles Commons & Mattin Center (PAGAC) systems. Earn points for the semester leaderboard!",
    icon: "🐯",
    highScore: 9420,
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["Charles Commons (GSU) Food Court", "Albert S. Charles Commons & Mattin Center (PAGAC) Floors 2-3", "Blue Jay Stadium", "South Garage (Wyman Park)"],
        correctIndex: 1,
        explanation: "Charles Commons & Mattin Center (PAGAC) floors remain open 24/7 for midterm and finals study sessions.",
      },
      {
        id: "q4",
        question: "What is the primary shuttle loop connecting Blue Jay Square to Charles Commons (GSU)?",
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: "The iconic bronze Johns Hopkins University Blue Jay statue stands proudly at Red Square outside Charles Commons & Mattin Center (PAGAC).",
      },
    ],
    leaderboard: [
...
export const initialCampusNotifications: CampusNotification[] = [
  ...
  },
  {
    ...
    body: "Amara Diallo posted: Cultural Night rehearsal schedule at Charles Commons (GSU) Ballroom is set!",
    timeAgo: "1h ago",
    isRead: false,
...
export const initialLiveActivities: LiveCampusActivity[] = [
  ...
  },
  {
    ...
    location: "Charles Commons (GSU) North Loading Dock",
    attendeesCount: 31,
...
export const initialServiceRequests: CampusServiceRequest[] = [
  {
    ...
    location: "Charles Commons & Mattin Center (PAGAC) 2nd Floor Pod B",
...
export const initialEventMemories: EventMemory[] = [
  {
    ...
    photosCount: 426,
    aiGeneratedRecap:
      "Over 184 students converged in the Charles Commons (GSU) for 12 hours of rapid prototyping. 32 completed projects were demoed across autonomous security, campus sustainability, and accessible transit. Team 'CyberPulse' took first place with their automated honeypot mesh.",
...
export const initialCampusPosts: CampusPost[] = [
  {
    ...
    scope: "CAMPUS_WIDE",
    location: "Charles Commons (GSU) Ballroom",
    content:
      "🎉 Cultural Night is this Friday at 7:00 PM in the Charles Commons (GSU)! Experience live music, authentic African cuisines, cultural fashion runway, and student dance performances. Free admission for all Johns Hopkins University students!",
...
export const initialCampusEvents: CampusEvent[] = [
  ...
  },
  {
    ...
    category: "Concert",
    location: "Blue Jay Stadium Lawn & Charles Commons (GSU) Beach",
    ...
    recommendationReason: "Johns Hopkins University's biggest tradition of the year! Live national headliners, ferris wheel, carnival games, and 12 local Baltimore food trucks.",
  ...
  },
  {
    ...
    location: "Charles Commons (GSU) Ballrooms (UU-300)",
    buildingCode: "UU-300",
    dateMonth: "MAR",
    dateDay: "27",
    ...
    gateEntrance: "Charles Commons (GSU) 3rd Floor Ballroom Entrance",
  ...
  },
  {
    ...
    clubName: "Campus Activities Board (CAB)",
    category: "Tradition",
    location: "Charles Commons (GSU) Amphitheater & Lawn",
  ...
  },
  {
    ...
    category: "Cultural Festival",
    location: "Potomac Lounge (Charles Commons (GSU))",
...
export const initialCampusClubs: CampusClub[] = [
  {
    ...
    meetingLocation: "Charles Commons (GSU) Rm 320",
    foundedYear: 1994,
  ...
  },
  {
    ...
    meetingLocation: "Charles Commons (GSU) Ballroom West",
    foundedYear: 1969,
  ...
  },
  {
    ...
    meetingLocation: "Charles Commons (GSU) Senate Chambers (Rm 324)",
    foundedYear: 1921,
  ...
  },
  {
    ...
    meetingLocation: "Charles Commons (GSU) Multipurpose Rm",
    foundedYear: 1971,
  ...
  },
  {
    ...
    meetingLocation: "Charles Commons (GSU) Rm 204",
    foundedYear: 1973,
  ...
  },
  {
    ...
    meetingLocation: "Charles Commons (GSU) Rm 314",
    foundedYear: 1988,
  ...
  },
  {
    ...
    meetingLocation: "Charles Commons (GSU) Media Suite Rm 208",
    foundedYear: 1921,
  ...
  },
  {
    ...
    meetingLocation: "Charles Commons (GSU) CAB Suite",
    foundedYear: 1968,
  ...
  },
  {
    ...
    description: "Protecting Johns Hopkins University's 12-acre Wicomico River Greenway forest ecosystem, native species restoration, and campus sustainability initiatives.",
    logo: "🌲",
...
export const initialVolunteerActivities: VolunteerActivity[] = [
  {
    ...
    location: "Charles Commons (GSU) North Loading Dock & Food Hub",
  ...
  },
  {
    ...
    organizer: "JHU Environmental Alliance & Wicomico River Greenway Board",
    organizerAvatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80",
    location: "Wicomico River Greenway Trailhead (Near Mergenthaler Hall)",
  ...
  {
    id: "vol-7",
    title: "Johns Hopkins University Community Clean-Up & Bateman Street Corridor Spruce",
    category: "Campus Cleanup",
...
export const initialCampusJobs: CampusJob[] = [
  {
    id: "job-1",
    title: "Charles Commons & Mattin Center (PAGAC) Student Technology Assistant",
    department: "Albert S. Charles Commons & Mattin Center (PAGAC) · Tech Desk",
    type: "Student Assistant",
    payRate: "$16.50 / hr",
    hoursPerWeek: "12-15 hrs/week",
    location: "Charles Commons & Mattin Center (PAGAC) 1st Floor",
...
export const initialStudyPods: CourseStudyPod[] = [
  {
    ...
    roomLocation: "Albert S. Charles Commons & Mattin Center (PAGAC) 2nd Floor, Pod B",
...
export const initialCampusPolls: CampusPoll[] = [
  {
    ...
    options: [
      ...
      { id: "opt-3", text: "C. Charles Commons & Mattin Center (PAGAC) Quiet Pod Tech Displays", votes: 172 },
...
export const initialHousingListings: HousingListing[] = [
  ...
  },
  {
    ...
    mapCoords: { x: 72, y: 18 },
    isSaved: false,
    description: "Spacious colonial student house with hard-wood floors, high-speed fiber internet, and quiet residential neighborhood 1 mile from Charles Commons & Mattin Center (PAGAC).",
  },
  {
    id: "hse-3",
    ...
    mapCoords: { x: 42, y: 15 },
    isSaved: false,
    description: "Luxury off-campus student high-rise right above Whole Foods and Target in Downtown Johns Hopkins University. 10-minute walk to Red Square.",
  },
];
...
export const initialFacilityDensities: LiveFacilityDensity[] = [
  {
    id: "fac-1",
    facilityName: "Albert S. Charles Commons & Mattin Center (PAGAC)",
  ...
  {
    id: "fac-3",
    facilityName: "Charles Commons (GSU) Food Court",
...
export const initialSafeWalkSession: SafeWalkSession = {
  id: "sw-1",
  originName: "Albert S. Charles Commons & Mattin Center (PAGAC)",
...
export const initialCampusPersonas: UserProfile[] = [
  {
    ...
    ghostModeEnabled: false,
    currentLocationName: "Albert S. Charles Commons & Mattin Center (PAGAC) • 3rd Floor",
  },
  {
    id: "usr-2",
  ...
  },
  {
    ...
    isLocationSharing: true,
    ghostModeEnabled: false,
    currentLocationName: "Charles Commons (GSU) Food Court",
  },
  {
    id: "usr-4",
...
export const initialAdminAuditLogs: AdminSecurityAuditLog[] = [
  {
    ...
    details: "SafeWalk escort initiated: Charles Commons & Mattin Center (PAGAC) ➔ Marshall Hall Dorm (Companion: Maya Chen)",
