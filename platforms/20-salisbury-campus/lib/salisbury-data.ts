...
export const initialSalisburyBuildings: SalisburyBuilding[] = [
  ...
  {
    id: "bld-cook",
    name: "Albert S. Patricia R. Guerrieri Academic Commons (PAGAC)",
    code: "COOK-24",
    shortCode: "COOK",
    category: "Library",
...
export const initialCampusEvents: CampusEvent[] = [
  ...
  },
  {
    ...
    recommendationReason: "Salisbury's biggest tradition of the year! Live national headliners, ferris wheel, carnival games, and 12 local Baltimore food trucks.",
...
export const initialVolunteerActivities: VolunteerActivity[] = [
  ...
  },
  {
    ...
    organizer: "Salisbury Cybersecurity Club & Baltimore City Schools",
...
export const initialAdminVerifications: AdminVerificationRequest[] = [
  ...
  {
    id: "ver-4",
    applicantName: "The York Salisbury Student Residences",
    email: "leasing@theyorksalisbury.com",
