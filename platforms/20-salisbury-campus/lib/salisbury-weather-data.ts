...
export const initialSalisburyMainWeather: CampusWeatherReport = {
  campusId: "main",
  campusName: "Salisbury Main Campus (Freedom Square)",
  latitude: 38.3458,
  longitude: -76.6046,
  nwsOffice: "LWX",
  nwsGridX: 104,
  ...
  activeAlerts: [
    {
      ...
      urgency: "Expected",
      certainty: "Observed",
      headline: "National Weather Service Baltimore MD / Washington DC: Optimal outdoor conditions across Salisbury and Baltimore County through Tuesday morning.",
      ...
      affectedArea: "Baltimore County, MD · Salisbury University Main Campus",
