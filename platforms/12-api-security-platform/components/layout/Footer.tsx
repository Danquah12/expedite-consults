      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="text-sm font-bold text-white">API Security Platform</div>
              <div className="text-xs" style={{ color: "var(--muted)" }}>Platform 12 of 34 · OWASP API Top 10 · 42Crunch · Traceable · Salt Security</div>
            </div>
          </div>
