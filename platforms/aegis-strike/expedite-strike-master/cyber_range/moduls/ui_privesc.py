...
def layout() -> html.Div:
    return html.Div([
        ...
        dcc.Interval(id="privesc-poll", interval=2000, disabled=True, max_intervals=120),
...
@callback(
    Output("privesc-results",    "data"),
    Output("privesc-status",     "children"),
    Output("privesc-stats-bar",  "children"),
    Output("privesc-tl",         "style"),
    Output("privesc-tl-label",   "children"),
    Output("privesc-poll",       "disabled"),
...
@callback(
    ...
    Output("privesc-poll",       "disabled", allow_duplicate=True),
    Input("privesc-poll",        "n_intervals"),
    prevent_initial_call=True,
)
def poll_privesc(n):
    with _LOCK:
