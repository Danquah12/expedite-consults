            ...
            dbc.Row([
                dbc.Col(html.Div([
                    html.Div("System Name", style={"color": "#636e72", "fontSize": "8px",
                                                    "letterSpacing": "1px"}),
                    html.Div("Aegis Security Platform", style={"color": "#82aaff", "fontSize": "13px",
                                                                 "fontWeight": "700"}),
                ], style={"background": "#1a1d24", "borderRadius": "6px", "padding": "10px"}), md=4),
                dbc.Col(html.Div([
...
<p style='font-size:12px;color:#999'>This assessment was generated by the <strong>Aegis Security Operations Center</strong>
