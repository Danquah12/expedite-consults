...
────────────────────────
Deliberately VULNERABLE test API server for AEGIS API Assessment scanner.
...
def index():
    ...
    <p>Running on port 7777 — for AEGIS scanner testing only.</p>
    <ul>
...
if __name__ == "__main__":
    ...
    print("  Paste in AEGIS API Assessment → Base URL")
