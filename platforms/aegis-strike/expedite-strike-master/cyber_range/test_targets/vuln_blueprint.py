"""
Aegis Vulnerable Test Target — Flask Blueprint
===============================================
...
_API_KEY = "sk-mock-dummy-key-placeholder"
...
def _html(body, title="Aegis Vuln Target"):
...
<hr><p style="color:#666">AEGIS Test Target v1.0 — Flask</p>
...
SECRET_KEY=aegis-test-secret-key-do-not-use
""", mimetype="text/plain")
...
def sqli():
    ...
    db = sqlite3.connect("/tmp/aegis_vuln.db")
