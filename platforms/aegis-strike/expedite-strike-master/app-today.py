...
from neo4j_integration import get_full_graph
...
# ==========================================================
# POPULATE NEO4J GRAPH (CRITICAL FOR KILLCHAIN & SIMULATOR)
# ==========================================================
from neo4j_integration import get_full_graph
...
def load_neo4j_graph(category, gtype):
    try:
        elements = get_full_graph()
        if not elements:
            return [], "⚠ No graph data available in Neo4j"
        return elements, f"Loaded {len(elements)} nodes + edges from Neo4j"
    except Exception as e:
        return [], f"⚠ Neo4j Graph Error: {e}"


# ==========================================================
#  REGISTER KILL CHAIN CALLBACKS
# ==========================================================
from cyber_range.moduls.ui_killchain import register_callbacks as kc_callbacks
kc_callbacks(app)

# ==========================================================
#  REGISTER KILL CHAIN CALLBACKS (must be AFTER app is created)
# ==========================================================
from cyber_range.moduls.ui_killchain import register_callbacks as kc_callbacks
kc_callbacks(app)
...
# ======================================================================
# POPULATE Kill Chain Node DROPDOWNS
# ======================================================================
@app.callback(
    [
...
def populate_killchain_nodes(elements):
    if not elements:
        return [], []
...
def run_killchain(n, start, target):
