 ...
 * for Johns Hopkins Homewood University Campus Ecosystem (Johns Hopkins HomewoodSync)
 */
...
export interface NWSWeatherAlert {
  ...
  affectedArea: string;     // e.g. "Baltimore County, MD · Johns Hopkins Homewood University Campus"
...
export interface CampusOperatingStatus {
  ...
  title: string;
  announcement: string;
  shuttleStatus: string;    // e.g. "All JHMI Homewood-East Baltimore Shuttles & Night Ride Vans running on schedule."
  diningStatus: string;     // e.g. "Charles Commons & Levering Hall & Hopkins Cafe (FFC) Open"
  facilitiesStatus: string; // e.g. "O'Connor Recreation Center & Brody & MSE Library Open Normal Hours"
  issuedBy: string;         // e.g. "Johns Hopkins Homewood University Emergency Management / Provost"
  updatedAt: string;
...
// ─────────────────────────────────────────────────────────────
export const initialHopkinsMainWeather: CampusWeatherReport = {
  campusId: "main",
  campusName: "Johns Hopkins Homewood Main Campus (Keyser Quad)",
  latitude: 39.3299,
  longitude: -76.6046,
  nwsOffice: "LWX",
  nwsGridX: 104,
  ...
  activeAlerts: [
    {
      ...
      urgency: "Expected",
      certainty: "Observed",
      headline: "National Weather Service Baltimore MD / Washington DC: Optimal outdoor conditions across Johns Hopkins Homewood and Baltimore County through Tuesday morning.",
      ...
      issuingOffice: "NWS Baltimore MD / Washington DC (LWX - Station KBWI/KDMH)",
      affectedArea: "Baltimore County, MD · Johns Hopkins Homewood University Main Campus",
  ...
  operatingStatus: {
    ...
    title: "Johns Hopkins Homewood University: Normal Operational Status",
    announcement: "All academic facilities, Brody & MSE Library, and campus dining locations are open on standard schedules. No weather delays in effect.",
    shuttleStatus: "All JHMI Homewood-East Baltimore Shuttles & Night Ride Vans running on schedule.",
    diningStatus: "Charles Commons & Levering Hall, Wolman Hall Market Hall, and Hopkins Cafe (FFC) operating standard hours.",
    facilitiesStatus: "O'Connor Recreation Center and Brody & MSE Library 24/7 study pods open.",
    issuedBy: "Johns Hopkins Homewood University Emergency Management & Campus Operations",
