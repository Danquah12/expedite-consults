 ...
 * for UMBC Catonsville University Campus Ecosystem (UMBC CatonsvilleSync)
 */
...
export interface NWSWeatherAlert {
  ...
  affectedArea: string;     // e.g. "Baltimore County, MD · UMBC Catonsville University Campus"
...
export interface CampusOperatingStatus {
  ...
  title: string;
  announcement: string;
  shuttleStatus: string;    // e.g. "All UMBC Transit Lines (Arbutus, BWI/Arundel Mills, Downtown Baltimore) running on schedule."
  diningStatus: string;     // e.g. "The Commons Student Life Center & True Grit's Dining Hall Open"
  facilitiesStatus: string; // e.g. "Retriever Activities Center (RAC) & Albin O. Kuhn (AOK) Library Open Normal Hours"
  issuedBy: string;         // e.g. "UMBC Catonsville University Emergency Management / Provost"
  updatedAt: string;
...
// ─────────────────────────────────────────────────────────────
// AUTHENTIC UMD COLLEGE PARK WEATHER SEED DATA
// ─────────────────────────────────────────────────────────────
export const initialUmbcMainWeather: CampusWeatherReport = {
  campusId: "main",
  campusName: "UMBC Catonsville Main Campus (The Commons Quad)",
  latitude: 39.2556,
  longitude: -76.6046,
  nwsOffice: "LWX",
  nwsGridX: 104,
  ...
  activeAlerts: [
    {
      ...
      urgency: "Expected",
      certainty: "Observed",
      headline: "National Weather Service Baltimore MD / Washington DC: Optimal outdoor conditions across UMBC Catonsville and Baltimore County through Tuesday morning.",
      ...
      issuingOffice: "NWS Baltimore MD / Washington DC (LWX - Station KBWI)",
      affectedArea: "Baltimore County, MD · UMBC Catonsville University Main Campus",
  ...
  operatingStatus: {
    ...
    title: "UMBC Catonsville University: Normal Operational Status",
    announcement: "All academic facilities, Albin O. Kuhn (AOK) Library, and campus dining locations are open on standard schedules. No weather delays in effect.",
    shuttleStatus: "All UMBC Transit Lines (Arbutus, BWI/Arundel Mills, Downtown Baltimore) running on schedule.",
    diningStatus: "The Commons Student Life Center, Chesapeake Hall Market Hall, and True Grit's Dining Hall operating standard hours.",
    facilitiesStatus: "Retriever Activities Center (RAC) and Albin O. Kuhn (AOK) Library 24/7 study pods open.",
    issuedBy: "UMBC Catonsville University Emergency Management & Campus Operations",
