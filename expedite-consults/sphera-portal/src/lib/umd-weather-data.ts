 ...
 * for UMD College Park University Campus Ecosystem (UMD College ParkSync)
 */
...
export interface NWSWeatherAlert {
  ...
  affectedArea: string;     // e.g. "Baltimore County, MD · UMD College Park University Campus"
...
export interface CampusOperatingStatus {
  ...
  title: string;
  announcement: string;
  shuttleStatus: string;    // e.g. "All Shuttle-UM Buses (104 Metro, 105 Campus Connector, 111 Silver Spring) running on schedule."
  diningStatus: string;     // e.g. "Adele H. Stamp Student Union (The Stamp) & The Yahentamitsi Dining Hall Open"
  facilitiesStatus: string; // e.g. "Eppley Recreation Center (ERC) & McKeldin Library Open Normal Hours"
  issuedBy: string;         // e.g. "UMD College Park University Emergency Management / Provost"
  updatedAt: string;
...
// ─────────────────────────────────────────────────────────────
export const initialUmdMainWeather: CampusWeatherReport = {
  campusId: "main",
  campusName: "UMD College Park Main Campus (McKeldin Mall)",
  latitude: 38.9869,
  longitude: -76.6046,
  nwsOffice: "LWX",
  nwsGridX: 104,
  ...
  activeAlerts: [
    {
      ...
      urgency: "Expected",
      certainty: "Observed",
      headline: "National Weather Service Baltimore MD / Washington DC: Optimal outdoor conditions across UMD College Park and Baltimore County through Tuesday morning.",
      ...
      issuingOffice: "NWS Baltimore MD / Washington DC (LWX - Station KCGS)",
      affectedArea: "Baltimore County, MD · UMD College Park University Main Campus",
  ...
  operatingStatus: {
    ...
    title: "UMD College Park University: Normal Operational Status",
    announcement: "All academic facilities, McKeldin Library, and campus dining locations are open on standard schedules. No weather delays in effect.",
    shuttleStatus: "All Shuttle-UM Buses (104 Metro, 105 Campus Connector, 111 Silver Spring) running on schedule.",
    diningStatus: "Adele H. Stamp Student Union (The Stamp), Prince Frederick Hall Market Hall, and The Yahentamitsi Dining Hall operating standard hours.",
    facilitiesStatus: "Eppley Recreation Center (ERC) and McKeldin Library 24/7 study pods open.",
    issuedBy: "UMD College Park University Emergency Management & Campus Operations",
