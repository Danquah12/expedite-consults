...
export const ADMIN_USERS_DIRECTORY: AdminUserRecord[] = [
  ...
  },
  {
    ...
    roles: ['SUPER_ADMIN', 'Platform IAM Architect'],
    enforcementStatus: 'Active',
    verificationLevel: 'Enterprise Fellow',
    mfaStatus: 'Hardware Token (FIDO2) ✓',
    riskLevel: 'Low',
    organization: 'ConnectIn Enclave Operations',
    location: 'Washington, DC',
    connectionsCount: 25000,
    lastLogin: 'Active Now',
    registeredAt: 'Jul 01, 2026',
    reportsCount: 0,
    notes: 'Super Administrator & Root Key Custodian'
  },
  {
    id: 'USR-89420',
    name: 'Rhoda Mensah',
    ...
    roles: ['NORMAL_USER', 'Compliance Analyst'],
    enforcementStatus: 'Active',
    verificationLevel: 'Email Verified',
    mfaStatus: 'Email 2FA ✓',
    riskLevel: 'Low',
    organization: 'Expedite Consults Network',
    location: 'Washington DC-Baltimore Area',
    connectionsCount: 140,
    lastLogin: 'Active Now',
    registeredAt: 'Today',
    reportsCount: 0,
    notes: 'Newly registered verified member'
  },
  {
    id: 'USR-89421',
    name: 'Rhoda',
    ...
    mfaStatus: 'Email 2FA ✓',
    riskLevel: 'Low',
    organization: 'ConnectIn Network',
