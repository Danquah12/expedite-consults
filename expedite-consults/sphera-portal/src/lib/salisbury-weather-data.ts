 ...
 * for Salisbury University Campus Ecosystem (SalisburySync)
 */
...
export interface NWSWeatherAlert {
  ...
  affectedArea: string;     // e.g. "Baltimore County, MD · Salisbury University Campus"
...
export interface CampusOperatingStatus {
  ...
  title: string;
  announcement: string;
  shuttleStatus: string;    // e.g. "All Sea Gull Shuttles (Red, Gold, Route 13 Express) running on schedule."
  diningStatus: string;     // e.g. "Guerrieri Student Union (GSU) & Commons Dining Hall Open"
  facilitiesStatus: string; // e.g. "Maggs PAC Rec Center & PAGAC Library Open Normal Hours"
  issuedBy: string;         // e.g. "Salisbury University Emergency Management / Provost"
  updatedAt: string;
...
// ─────────────────────────────────────────────────────────────
// AUTHENTIC SALISBURY UNIVERSITY WEATHER SEED DATA
// ─────────────────────────────────────────────────────────────
export const initialSalisburyMainWeather: CampusWeatherReport = {
  campusId: "main",
  campusName: "Salisbury Main Campus (Red Square)",
  latitude: 38.3458,
  longitude: -75.6046,
  nwsOffice: "AKQ",
  nwsGridX: 96,
  nwsGridY: 74,
  nwsStationId: "KSBY",
  lastUpdated: "Just now (NOAA / NWS AKQ - Station KSBY)",
  currentTemp: 72,
  feelsLike: 74,
  highToday: 78,
  lowToday: 58,
  ...
  activeAlerts: [
    {
      id: "nws-alert-akq-0912",
      event: "Special Weather Statement: Pleasant Air Mass Over Eastern Shore",
      severity: "Minor",
      urgency: "Expected",
      certainty: "Observed",
      headline: "National Weather Service Wakefield VA: Optimal coastal plain conditions across Salisbury and Wicomico County through Tuesday morning.",
      description: "A stable high-pressure system continues to provide seasonal temperatures and moderate humidity across Maryland's Lower Eastern Shore. Low risk of hazardous weather for campus operations.",
      ...
      issuingOffice: "NWS Wakefield VA / Salisbury MD (AKQ)",
      affectedArea: "Wicomico County, MD · Salisbury University Campus · Eastern Shore",
  ...
  operatingStatus: {
    ...
    title: "Salisbury University: Normal Operational Status",
    announcement: "All academic facilities, PAGAC Library, and campus dining locations are open on standard schedules. No weather delays in effect.",
    shuttleStatus: "All Sea Gull Shuttles (Red, Gold, Route 13 Express) running on schedule.",
    diningStatus: "Guerrieri Student Union (GSU), Severn Hall Market Hall, and Commons Dining Hall operating standard hours.",
    facilitiesStatus: "Maggs PAC Rec Center and PAGAC Library 24/7 study pods open.",
    issuedBy: "Salisbury University Emergency Management & Campus Operations",
