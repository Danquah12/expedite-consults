...
export default function FeedPage() {
  ...
  const [posts, setPosts] = useState(mockTikTokPosts);
      ...
      <div className="w-full max-w-[620px] flex flex-col gap-4">
        ...
        {posts.map((post) => (
          ...
          >
            ...
            {/* TikTok Video / Media Frame with Floating Interaction Rail */}
            <div className="relative w-full bg-black flex justify-center items-center overflow-hidden min-h-[380px] max-h-[580px] select-none">
              ...
              {/* ── TIKTOK SIDE ENGAGEMENT RAIL (Right Side) ── */}
              ...
              {/* ── TIKTOK AUDIO & SOUND SCROLLING MARQUEE (Bottom Left) ── */}
              {post.musicTitle && (
