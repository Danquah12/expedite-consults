...
const BENCHMARK_METRICS: BenchmarkMetric[] = [
  {
    ...
    unit: "mins",
    orgHistoricalValue: 228.0,
    industryBaselineValue: 12240.0,
    slaTarget: 30.0,
    betterIs: "LOWER",
  ...
  },
  {
    ...
    unit: "mins",
    orgHistoricalValue: 384.0,
    industryBaselineValue: 4380.0,
    slaTarget: 45.0,
    betterIs: "LOWER",
  ...
  },
  {
    ...
    unit: "mins",
    orgHistoricalValue: 180.0,
    industryBaselineValue: 1440.0,
    slaTarget: 60.0,
    betterIs: "LOWER",
