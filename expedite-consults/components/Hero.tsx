		...
		<div
			style={{
				backgroundImage: site?.heroImage
					...
					: "url(/images/hero-building-dusk.jpg)",
			}}
			className="relative w-full z-[1] h-[580px] lg:h-[750px] bg-[url(/images/hero-building-dusk.jpg)] bg-no-repeat bg-cover bg-center bg-blend-overlay flex flex-col gap-4 items-center justify-center pt-10"
		>
