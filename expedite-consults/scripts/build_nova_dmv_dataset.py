...
properties = [
    {
        ...
        "shapDrivers": [
            {"category": "Neighborhood Trends", "driver": "Clarendon Metro Walkshed (0.35 mi)", "impact": 48000, "description": "High demand transit corridor to Amazon HQ2 and Downtown DC."},
            {"category": "Renovation & Condition", "driver": "Permitted Two-Story Rear Addition & Chef Kitchen", "impact": 42500, "description": "Arlington County ePlan Permit #BLD-2023-881 signed off by structural engineer."},
            {"category": "Neighborhood Trends", "driver": "Yorktown High School Attendance Boundary", "impact": 24000, "description": "Top-tier Arlington Public Schools (APS) cluster rating 9.5/10."},
            {"category": "Renovation & Condition", "driver": "16-Year-Old Dual-Zone HVAC Compressors", "impact": -11000, "description": "SEER 13 units approaching end of rated lifecycle; recommended heat pump upgrade."},
            {"category": "Property Characteristics", "driver": "Detached 1-Car Garage (Shared Driveway)", "impact": -14000, "description": "Shared easement common in Lyon Village; slight deduction vs private drive."}
        ],
        "permits": [
            {"id": "ARL-BLD-2023-881", "type": "Two-Story Addition & Electrical Upgrade", "cost": 115000, "year": 2023, "status": "Finaled"},
            {"id": "ARL-PLM-2021-419", "type": "Tankless Gas Water Heater Installation", "cost": 6200, "year": 2021, "status": "Finaled"},
            {"id": "ARL-ROF-2018-092", "type": "Architectural Shingle Roof Replacement", "cost": 14800, "year": 2018, "status": "Finaled"}
        ],
        "comparables": [
            {"id": "c-101", "address": "1218 N Hartford St", "price": 1490000, "distanceMi": 0.05, "similarity": 0.96, "soldDate": "2026-08-04", "sqft": 3080},
            {"id": "c-102", "address": "1304 N Highland St", "price": 1520000, "distanceMi": 0.18, "similarity": 0.93, "soldDate": "2026-07-15", "sqft": 3200}
        ],
        "timeline": [
            {"year": 1928, "title": "Original Construction", "type": "built", "cost": 12000, "description": "Classic brick & cedar shake American Craftsman home completed."},
            {"year": 2004, "title": "Arms-Length Transfer", "type": "sale", "cost": 710000, "description": "Deed recorded in Arlington County Land Records."},
            {"year": 2014, "title": "Second Ownership Transfer", "type": "sale", "cost": 995000, "description": "Sold with multiple offers in 8 days."},
            {"year": 2018, "title": "CertainTeed Landmark Roof", "type": "permit", "cost": 14800, "description": "Architectural shingle replacement with lifetime ice/water shield."},
            {"year": 2021, "title": "Rinnai Tankless Water Heater", "type": "permit", "cost": 6200, "description": "Energy efficiency mechanical upgrade, finaled by Arlington county."},
            {"year": 2023, "title": "Major Two-Story Rear Addition", "type": "renovation", "cost": 115000, "description": "Expanded primary suite, custom walk-in closet, and open chef's kitchen."},
            {"year": 2026, "title": "Listed for Sale on Bright MLS", "type": "listed", "cost": 1495000, "description": "48h verified active listing on TruePlace."}
        ],
        "healthScores": {
            "overall": 91,
            "structural": 95,
    ...
    },
    {
        ...
        "floodRiskLevel": "Minimal",
        "wildfireScore": 1,
        "coordinates": {"lat": 38.9432, "lng": -77.1654},
        "listingAgent": {
        ...
        "shapDrivers": [
            {"category": "Neighborhood Trends", "driver": "Langley High School Pyramid (FCPS #1 Tier)", "impact": 110000, "description": "Highest ranked public secondary school in Virginia."},
            {"category": "Property Characteristics", "driver": "0.83-Acre Private Wooded Buffer & Heated Pool", "impact": 92000, "description": "Complete natural privacy in gated grounds with stone summer pavilion."},
            {"category": "Renovation & Condition", "driver": "Custom Steel & Glass Pivot Entry + Sub-Zero/Wolf Suite", "impact": 68000, "description": "Commercial architectural finishes certified by Fairfax County LDS."}
        ],
        "permits": [
            {"id": "FFX-2021-9941", "type": "Custom Residential Estate New Construction", "cost": 1450000, "year": 2021, "status": "Finaled"},
            {"id": "FFX-2023-1120", "type": "Gunite Heated Pool & Spa Pavilion", "cost": 95000, "year": 2023, "status": "Finaled"}
        ],
        "comparables": [
            {"id": "c-201", "address": "6820 Sorrel St", "price": 3350000, "distanceMi": 0.08, "similarity": 0.95, "soldDate": "2026-07-22", "sqft": 6400}
        ],
        "timeline": [
            {"year": 2021, "title": "New Construction Completed", "type": "built", "cost": 1450000, "description": "Architect-designed estate with commercial grade framing and spray foam insulation."},
            {"year": 2023, "title": "Pool & Outdoor Living Pavilion", "type": "permit", "cost": 95000, "description": "Heated saltwater pool with automatic safety cover and gas fireplace."},
            {"year": 2026, "title": "Listed on Bright MLS", "type": "listed", "cost": 3250000, "description": "Verified active luxury estate."}
        ],
        "healthScores": {
            "overall": 98,
            "structural": 100,
    ...
    },
    {
        ...
        "floodRiskLevel": "Minimal",
        "wildfireScore": 1,
        "coordinates": {"lat": 38.8021, "lng": -77.0451},
        "listingAgent": {
            "name": "Harrison Wells",
        ...
        "shapDrivers": [
            {"category": "Neighborhood Trends", "driver": "Historic Old Town Historic District Corridor", "impact": 64000, "description": "Two blocks to King Street retail, restaurants, and waterfront park."},
            {"category": "Renovation & Condition", "driver": "Certified Historic Masonry Repointing & Copper Flashings", "impact": 34000, "description": "Alexandria Board of Architectural Review (BAR) approved restoration."},
            {"category": "Property Characteristics", "driver": "Private Brick Walled Courtyard Garden", "impact": 18000, "description": "Rare private outdoor space with brick herringbone paver patio."}
        ],
        "permits": [
            {"id": "ALX-BAR-2022-41", "type": "Historic Facade & Masonry Restoration", "cost": 48000, "year": 2022, "status": "Finaled"},
            {"id": "ALX-MEC-2020-19", "type": "High-Efficiency Mitsubishi Mini-Split Heat Pumps", "cost": 18500, "year": 2020, "status": "Finaled"}
        ],
        "comparables": [
            {"id": "c-301", "address": "322 S St Asaph St", "price": 1395000, "distanceMi": 0.03, "similarity": 0.96, "soldDate": "2026-08-01", "sqft": 2450}
        ],
        "timeline": [
            {"year": 1885, "title": "Victorian Townhome Construction", "type": "built", "cost": 4500, "description": "Original hand-molded brick townhouse built in Old Town core."},
            {"year": 2008, "title": "Arms-Length Sale", "type": "sale", "cost": 890000, "description": "Recorded in City of Alexandria Clerk's Office."},
            {"year": 2020, "title": "Zoned Mini-Split Heat Pumps", "type": "permit", "cost": 18500, "description": "Preserved historic plaster while adding modern zoned cooling."},
            {"year": 2022, "title": "BAR Historic Masonry Sign-Off", "type": "renovation", "cost": 48000, "description": "Tuckpointing with lime mortar to preserve historic structural integrity."},
            {"year": 2026, "title": "Active Listing on TruePlace", "type": "listed", "cost": 1385000, "description": "Verified active with clean HomeTruth title report."}
        ],
        "healthScores": {
            "overall": 92,
            "structural": 94,
    ...
    },
    {
        ...
        "floodRiskLevel": "Minimal",
        "wildfireScore": 1,
        "coordinates": {"lat": 39.0012, "lng": -77.2912},
        "listingAgent": {
            "name": "Evelyn Ross",
        ...
        "shapDrivers": [
            {"category": "Property Characteristics", "driver": "2.0-Acre Private Wooded Parcel with Pond Views", "impact": 98000, "description": "Large acreage estate zoning in Great Falls near Georgetown Pike."},
            {"category": "Neighborhood Trends", "driver": "Langley High / Cooper Middle School Catchment", "impact": 65000, "description": "Premier FCPS public school district ranking."},
            {"category": "Renovation & Condition", "driver": "Geothermal Ground-Source Heat Pump System", "impact": 42000, "description": "Zero net energy heating and cooling with $3,200/yr annual utility savings."}
        ],
        "permits": [
            {"id": "FFX-2019-4412", "type": "Single Family Residence & Septic Engineered Field", "cost": 1200000, "year": 2019, "status": "Finaled"},
            {"id": "FFX-2023-0911", "type": "Geothermal Well Drilling & Heat Pump Integration", "cost": 54000, "year": 2023, "status": "Finaled"}
        ],
        "comparables": [
            {"id": "c-401", "address": "9820 Walker Lake Dr", "price": 2950000, "distanceMi": 0.12, "similarity": 0.94, "soldDate": "2026-06-18", "sqft": 5750}
        ],
        "timeline": [
            {"year": 2019, "title": "Estate Construction", "type": "built", "cost": 1200000, "description": "Full stone exterior construction with 3-car heated garage."},
            {"year": 2023, "title": "Geothermal System Upgrade", "type": "renovation", "cost": 54000, "description": "Closed-loop geothermal heat pumps installed with tax credits."},
            {"year": 2026, "title": "Listed Active", "type": "listed", "cost": 2890000, "description": "Priced competitively below TrueValue estimate."}
        ],
        "healthScores": {
            "overall": 97,
            "structural": 98,
    ...
    },
    {
        ...
        "floodRiskLevel": "Minimal",
        "wildfireScore": 1,
        "coordinates": {"lat": 38.9054, "lng": -77.2712},
        "listingAgent": {
            "name": "Marcus Vance",
        ...
        "shapDrivers": [
            {"category": "Neighborhood Trends", "driver": "Madison High School & Town of Vienna Amenities", "impact": 45000, "description": "Walking distance to Church Street dining and W&OD recreational trail."},
            {"category": "Renovation & Condition", "driver": "Finished Walk-Out Basement Suite with Wet Bar", "impact": 28000, "description": "Full permitted legal lower-level living suite with full egress window."},
            {"category": "Property Characteristics", "driver": "Attached 2-Car Garage with 240V Level 2 EV Charger", "impact": 17000, "description": "Pre-wired dedicated electric vehicle circuit."}
        ],
        "permits": [
            {"id": "TOV-2017-101", "type": "New Construction Infill Residence", "cost": 540000, "year": 2017, "status": "Finaled"},
            {"id": "TOV-2022-81", "type": "Basement Buildout & EV Charging Circuit", "cost": 42000, "year": 2022, "status": "Finaled"}
        ],
        "comparables": [
            {"id": "c-501", "address": "418 Lawyers Rd NW", "price": 1165000, "distanceMi": 0.04, "similarity": 0.95, "soldDate": "2026-07-29", "sqft": 3150}
        ],
        "timeline": [
            {"year": 2017, "title": "Construction Finaled", "type": "built", "cost": 540000, "description": "Custom modern farmhouse built in Town of Vienna."},
            {"year": 2022, "title": "Finished Basement & EV Charger", "type": "renovation", "cost": 42000, "description": "Full lower-level suite added with town permits."},
            {"year": 2026, "title": "Active Listing", "type": "listed", "cost": 1150000, "description": "Listed at advantageous valuation relative to model."}
        ],
        "healthScores": {
            "overall": 94,
            "structural": 96,
    ...
    },
    {
        ...
        "floodRiskLevel": "Minimal",
        "wildfireScore": 1,
        "coordinates": {"lat": 38.9681, "lng": -77.3412},
        "listingAgent": {
            "name": "David Hayes",
        ...
        "shapDrivers": [
            {"category": "Property Characteristics", "driver": "Direct Lake Anne Water View & Private Dock", "impact": 44000, "description": "Rare waterfront dock mooring for electric boat or kayak."},
            {"category": "Neighborhood Trends", "driver": "Reston Town Center Silver Line Metro Access", "impact": 22000, "description": "Fast mass-transit link to Dulles Airport and Tysons."},
            {"category": "Renovation & Condition", "driver": "Reston Association (RA) Certified Cedar Siding Resto", "impact": 15000, "description": "Complete exterior envelope restoration complying with RA design covenants."}
        ],
        "permits": [
            {"id": "FFX-2022-771", "type": "Interior Kitchen & Bath Gut Remodel", "cost": 65000, "year": 2022, "status": "Finaled"}
        ],
        "comparables": [
            {"id": "c-601", "address": "11418 Waterview Cluster", "price": 790000, "distanceMi": 0.02, "similarity": 0.96, "soldDate": "2026-08-10", "sqft": 2080}
        ],
        "timeline": [
            {"year": 1968, "title": "Lake Anne Townhome Built", "type": "built", "cost": 28000, "description": "Iconic Robert E. Simon planned community architectural townhome."},
            {"year": 2011, "title": "Sale Transfer", "type": "sale", "cost": 495000, "description": "Recorded in Fairfax County deed office."},
            {"year": 2022, "title": "Complete Modern Interior Gut", "type": "renovation", "cost": 65000, "description": "Open concept kitchen, quartz center island, luxury bathrooms."},
            {"year": 2026, "title": "Listed on Market", "type": "listed", "cost": 780000, "description": "Verified active 48h listing."}
        ],
        "healthScores": {
            "overall": 90,
            "structural": 91,
    ...
    },
    {
        ...
        "floodRiskLevel": "Minimal",
        "wildfireScore": 1,
        "coordinates": {"lat": 38.8821, "lng": -77.1698},
        "listingAgent": {
            "name": "Elena Sterling",
        ...
        "shapDrivers": [
            {"category": "Neighborhood Trends", "driver": "Falls Church City Schools (Meridian High Tier)", "impact": 58000, "description": "Independent municipal school district ranked #2 in Virginia."},
            {"category": "Neighborhood Trends", "driver": "Broad Street / Downtown Falls Church Walkability", "impact": 32000, "description": "Walking distance to farmers market, Whole Foods, and state theater."},
            {"category": "Property Characteristics", "driver": "Wraparound Front Porch & Detached 2-Car Garage", "impact": 21000, "description": "Historic aesthetic with modern garage convenience."}
        ],
        "permits": [
            {"id": "FCC-2022-19", "type": "Screened Rear Porch & Paver Patio", "cost": 38000, "year": 2022, "status": "Finaled"}
        ],
        "comparables": [
            {"id": "c-701", "address": "216 E Columbia St", "price": 1260000, "distanceMi": 0.03, "similarity": 0.95, "soldDate": "2026-07-11", "sqft": 3000}
        ],
        "timeline": [
            {"year": 2012, "title": "Craftsman Construction Completed", "type": "built", "cost": 490000, "description": "Quality modern construction honoring historic architecture."},
            {"year": 2022, "title": "Screened Porch & Landscape", "type": "permit", "cost": 38000, "description": "Outdoor living space addition with municipal permit finaled."},
            {"year": 2026, "title": "Listed Active", "type": "listed", "cost": 1275000, "description": "Verified active listing in Falls Church City."}
        ],
        "healthScores": {
            "overall": 95,
            "structural": 97,
    ...
    },
    {
        ...
        "floodRiskLevel": "Minimal",
        "wildfireScore": 1,
        "coordinates": {"lat": 38.9912, "lng": -77.5121},
        "listingAgent": {
            "name": "David Hayes",
        ...
        "shapDrivers": [
            {"category": "Renovation & Condition", "driver": "10.8kW Solar Array & Enphase Battery Storage", "impact": 32000, "description": "Near-zero net utility bills with certified interconnection permit."},
            {"category": "Neighborhood Trends", "driver": "Loudoun County Data Center & Tech Corridor Employment", "impact": 26000, "description": "High tech executive employment base near Ashburn data alley."},
            {"category": "Property Characteristics", "driver": "Main Level Guest In-Law Suite with Full Bath", "impact": 18000, "description": "High demand multi-generational living configuration."}
        ],
        "permits": [
            {"id": "LOU-2023-110", "type": "Rooftop Solar & Electrical Battery Backup", "cost": 38000, "year": 2023, "status": "Finaled"}
        ],
        "comparables": [
            {"id": "c-801", "address": "42910 Creighton Rd", "price": 890000, "distanceMi": 0.08, "similarity": 0.94, "soldDate": "2026-07-19", "sqft": 3600}
        ],
        "timeline": [
            {"year": 2020, "title": "Brambleton Master Planned Home Built", "type": "built", "cost": 420000, "description": "Modern energy-efficient construction."},
            {"year": 2023, "title": "Solar & Battery Interconnection", "type": "permit", "cost": 38000, "description": "Clean energy installation finaled by Loudoun County inspectors."},
            {"year": 2026, "title": "Listed on Bright MLS", "type": "listed", "cost": 895000, "description": "48-hour active verified property."}
        ],
        "healthScores": {
            "overall": 96,
            "structural": 98,
    ...
    },
    {
        ...
        "floodRiskLevel": "Minimal",
        "wildfireScore": 1,
        "coordinates": {"lat": 38.9812, "lng": -77.1054},
        "listingAgent": {
            "name": "Jonathan Chen",
        ...
        "shapDrivers": [
            {"category": "Neighborhood Trends", "driver": "Bethesda Row Walkshed & Red Line Metro Access", "impact": 68000, "description": "Premier dining, shopping, and NIH/Walter Reed medical center access."},
            {"category": "Neighborhood Trends", "driver": "Walt Whitman / BCC High School Cluster", "impact": 44000, "description": "Top-tier Montgomery County Public Schools (MCPS) ranking."},
            {"category": "Renovation & Condition", "driver": "Custom Screened Deck with Outdoor Gas Fireplace", "impact": 22000, "description": "Architectural outdoor living space permitted in 2023."}
        ],
        "permits": [
            {"id": "MC-DPS-2023-41", "type": "Screened Porch & Outdoor Fireplace", "cost": 44000, "year": 2023, "status": "Finaled"}
        ],
        "comparables": [
            {"id": "c-901", "address": "7112 Exfair Rd", "price": 1680000, "distanceMi": 0.05, "similarity": 0.95, "soldDate": "2026-07-28", "sqft": 3900}
        ],
        "timeline": [
            {"year": 2015, "title": "Custom Infill Completed", "type": "built", "cost": 680000, "description": "High-end custom construction in prime Bethesda location."},
            {"year": 2023, "title": "Screened Porch & Deck", "type": "permit", "cost": 44000, "description": "Outdoor entertainment pavilion finaled by Montgomery County DPS."},
            {"year": 2026, "title": "Active Listing on Bright MLS", "type": "listed", "cost": 1650000, "description": "Maryland companion property to Northern Virginia corridor."}
        ],
        "healthScores": {
            "overall": 95,
            "structural": 97,
    ...
    },
    {
        ...
        "floodRiskLevel": "Minimal",
        "wildfireScore": 1,
        "coordinates": {"lat": 38.9112, "lng": -77.2054},
        "listingAgent": {
        ...
        "shapDrivers": [
            {"category": "Neighborhood Trends", "driver": "Tysons Corner Tech Hub & Silver Line Proximity (1.2 mi)", "impact": 42000, "description": "Direct access to Capital One HQ, shopping, and Metro rail."},
            {"category": "Renovation & Condition", "driver": "Pimmit Hills Infill Modern Architecture & 9ft Ceilings", "impact": 31000, "description": "Contemporary floor plan replacing original 1950s footprint."},
            {"category": "Property Characteristics", "driver": "Full Smart Home & Commercial EV Charging Ready", "impact": 14000, "description": "Lutron smart switches, dual zone Wi-Fi thermostats, and 50A garage outlet."}
        ],
        "permits": [
            {"id": "FFX-LDS-2021-99", "type": "Single Family Infill Construction", "cost": 490000, "year": 2021, "status": "Finaled"}
        ],
        "comparables": [
            {"id": "c-1001", "address": "1924 Leonard Rd", "price": 1065000, "distanceMi": 0.03, "similarity": 0.95, "soldDate": "2026-08-01", "sqft": 3050}
        ],
        "timeline": [
            {"year": 2021, "title": "Infill Replacement Completed", "type": "built", "cost": 490000, "description": "Replaced original 1952 rambler with contemporary 3-level residence."},
            {"year": 2026, "title": "Listed Active on Bright MLS", "type": "listed", "cost": 1050000, "description": "Priced below TrueValue estimate with 48h broker verification."}
        ],
        "healthScores": {
            "overall": 95,
            "structural": 97,
...
print(f"Successfully generated Northern Virginia DMV dataset with {len(properties)} properties to {target}")
