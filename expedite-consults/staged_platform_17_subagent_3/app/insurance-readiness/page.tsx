...
export default function InsuranceReadinessPage() {
  ...
  // Real-time calculation of Insurability Readiness Score (0 - 100)
  const stats = useMemo(() => {
    let totalEarned = 0;
    let totalPossible = 0;
  ...
  // Toggle compliance status for simulation
  ...
  return (
    <div style={{ padding: "24px 28px", minHeight: "calc(100vh - 54px)", background: "var(--bg)", display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      {/* Main Controls Matrix & Interactive Auditor */}
              ...
              >
                ...
                {isExpanded && (
                  <div style={{
                    ...
                    {/* Remediation Action if Partial or Non-compliant */}
      ...
      {/* Export Certified Evidence Package Modal */}
      {showExportModal && (
        <div style={{
          position: "fixed",
          inset: 0,
