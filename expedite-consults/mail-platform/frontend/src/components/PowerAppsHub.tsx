...
import { PowerApp } from '../types/connect';

export const MOCK_POWER_APPS: PowerApp[] = [
  {
    id: 'app-1',
  ...
  {
    id: 'app-2',
    name: 'Change Request (CR) ServiceNow Portal',
    description: 'Submit, review, and approve infrastructure change requests directly integrated with Teams.',
    category: 'IT & DevOps',
    icon: 'GitPullRequest',
    color: '#8B5CF6',
    recordsCount: 58,
...
export const PowerAppsHub: React.FC = () => {
  const [apps, setApps] = useState<PowerApp[]>(MOCK_POWER_APPS);
  ...
  const handleLaunchApp = (app: PowerApp) => {
    setSelectedApp(app);
    setFormData({});
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="font-bold text-sm text-slate-900">Axiom Power Apps Studio</h1>
              <span className="text-[10px] font-bold px-1.5 py-0.5 rounded bg-purple-100 text-purple-800">
                Low-Code Custom Apps
              </span>
            </div>
            <p className="text-[11px] text-slate-500">Build and deploy enterprise business applications connected to Mail, Teams & Dataverse</p>
          </div>
        </div>
            ...
            <div className="h-14 bg-slate-900 text-white px-5 flex items-center justify-between shrink-0">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-slate-400 font-mono">Axiom Model-Driven Form</span>
                </div>
              </div>
            ...
            {submittedAlert ? (
              <div className="p-12 text-center space-y-3">
                ...
                <p className="text-xs text-slate-500">
                  Data stored in custom Dataverse entity and automated Power Automate trigger dispatched to Teams #cyber-defense-loops.
                </p>
              </div>
            ) : (
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-xs flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl border border-slate-300 w-[500px] p-6 space-y-4">
            ...
            <div className="pt-2 flex justify-end gap-2">
              ...
              <button
                onClick={() => {
                  alert('New Custom Canvas App created in Dataverse repository!');
