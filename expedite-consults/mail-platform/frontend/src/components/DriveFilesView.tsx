...
import {
  ...
  Trash2, Plus, Search, ShieldCheck, Clock
} from 'lucide-react';
import { DriveFile } from '../types/connect';
...
export const DriveFilesView: React.FC = () => {
    ...
    <div className="flex-1 flex flex-col h-[calc(100vh-4rem)] overflow-hidden bg-white">
      ...
      <div className="h-12 bg-slate-50 border-b border-slate-200 px-4 flex items-center justify-between shrink-0 select-none">
        <div className="flex items-center gap-3">
          ...
          <div className="relative w-64">
            ...
            <input
              ...
              placeholder="Search Axiom Drive..."
        ...
        <div className="flex items-center gap-2 text-xs text-slate-500">
          <span>Storage: <strong>2.4 GB</strong> / 10 GB</span>
        </div>
      </div>

      {/* Drive Grid */}
      <div className="flex-1 p-6 overflow-y-auto">
        <h2 className="text-sm font-bold text-slate-900 mb-4">Axiom Cloud Drive — Shared Research & Documents</h2>
