...
// Specializing in Johns Hopkins University (JHU) (TU) Digital Campus & Geographic Engine
...
export interface HopkinsBuilding {
  id: string;
  name: string;
  code: string;
  shortCode: string;
...
export interface HopkinsShuttle {
  id: string;
  routeName: string;
  routeColor: string;
  busNumber: string;
...
export interface HopkinsParkingGarage {
  id: string;
  name: string;
  code: string;
  totalSpaces: number;
...
// 1. Initial Current User Profile (Johns Hopkins University Blue Jay)
export const defaultCurrentUser: UserProfile = {
  id: "usr-kwesi-asiedu",
  name: "Kwesi Asiedu",
  email: "k.asiedu@students.hopkins.edu",
  studentId: "#09124-JHU-26",
  major: "Information Technology",
  minor: "Cybersecurity & Systems",
  gradYear: 2026,
  classStanding: "Junior",
  dormBuilding: "Blue Jay Square, Marshall Hall #412",
  bio: "Johns Hopkins University Cybersecurity enthusiast. Student researcher in autonomous cyber defense loops. Treasurer of Johns Hopkins University Cybersecurity Club.",
  ...
  leadershipRoles: ["Johns Hopkins University Cybersecurity Club — Treasurer", "AI Research Society — Lead Builder"],
  achievements: ["🏆 JHU Hackathon 1st Place Finalist", "🏆 Division of Student Affairs Service Award", "🏆 Blue Jay Trivia Champion"],
  projects: ["AI Security & Cyber Threat Detection", "Johns Hopkins University Distributed Mesh Network"],
  isLocationSharing: false,
  ghostModeEnabled: false,
  currentLocationName: "Keyser Quadrangle (Near MSE Library & Brody Learning Commons)",
};

// 2. Johns Hopkins University (JHU) Campus Buildings Dataset (Authentic JHU Landmarks)
export const initialHopkinsBuildings: HopkinsBuilding[] = [
  {
    id: "bld-sc",
    name: "Brody Learning Commons & Milton S. Eisenhower Library",
    code: "SC-300",
    shortCode: "SC",
    category: "Academic",
  ...
  {
    id: "bld-mse",
    name: "Milton S. Eisenhower Library & Brody Learning Commons (MSE Library)",
    code: "MSE-24",
    shortCode: "MSE",
    category: "Library",
  ...
  },
  {
    ...
    description: "Heart of campus life featuring Chick-fil-A, Daily Grind Cafe (Brody), Chesapeake Roasting Co., SGA Senate Chamber, student organization offices, and Blue Jay Esports Arena.",
    x: 38,
    y: 58,
    distanceFt: 350,
    ...
    studySpacesCount: 30,
    classroomsCount: 6,
    accessibleEntrance: "West Entrance via Blue Jay Square Garage Skybridge",
    floorsCount: 3,
    ...
    floors: [
      {
        ...
        rooms: [
          { id: "un-101", roomNumber: "UN 101", name: "Johns Hopkins University Food Court (Chick-fil-A / Dunkin)", type: "Lounge", capacity: 300, hasAV: false, status: "Available" },
          { id: "un-108", roomNumber: "UN 108", name: "Blue Jay Esports & Gaming Arena", type: "Lab", capacity: 40, hasAV: true, status: "Available" },
        ],
      },
      {
        floorNumber: 2,
  ...
  {
    id: "bld-malone",
    name: "East Baltimore Medical Campus (JHH & Bloomberg)",
    code: "MALONE-100",
    shortCode: "MALONE",
    category: "Academic",
    ...
    studySpacesCount: 18,
    classroomsCount: 24,
    accessibleEntrance: "Main 33rd Street & University Pkwy Entrance (East Ramp)",
    floorsCount: 3,
  ...
  {
    id: "bld-oconnor-rec",
    name: "Ralph S. O'Connor Center for Recreation & Well-Being (PAC) & Rec Center",
    code: "OCONNOR-REC",
    shortCode: "OCONNOR-REC",
    category: "Athletics",
  ...
  {
    id: "bld-secu",
    name: "Blue Jay Stadium & Blue Jay Stadium",
    code: "SECU-ARENA",
    shortCode: "SECU",
    category: "Athletics",
  ...
  {
    id: "bld-west-village",
    name: "Blue Jay Square Commons & Dining",
    code: "WV-COMMONS",
    shortCode: "WV",
    category: "Residential",
    description: "Blue Jay Square student residential village featuring all-you-care-to-eat dining, Starbucks, convenience store, and Marshall Hall suites.",
    x: 15,
    y: 35,
    distanceFt: 780,
    openHours: "7:00 AM - 11:00 PM",
...
// 3. Blue JayOrbit 360 — Privacy-Preserving Campus Orbits & Circles (Life360 Suite)
export const initialHopkinsPlaces: CirclePlaceAlert[] = [
  {
    id: "place-library",
    placeName: "Milton S. Eisenhower Library & Brody Learning Commons (MSE Library)",
    icon: "📚",
    radiusMeters: 100,
  ...
  {
    id: "place-union",
    placeName: "Hopkins Student Center",
    icon: "🍕",
    radiusMeters: 120,
  ...
  {
    id: "place-science",
    placeName: "Brody Learning Commons & Milton S. Eisenhower Library",
    icon: "🔬",
    radiusMeters: 110,
  ...
  {
    id: "place-gym",
    placeName: "Ralph S. O'Connor Center for Recreation & Well-Being (PAC) & Rec Center",
    icon: "🏋️",
    radiusMeters: 100,
...
export const initialHopkinsCircles: LocationCircle[] = [
  {
    id: "circle-cyber",
    name: "Johns Hopkins University Cybersecurity Club",
    icon: "🛡️",
    inviteCode: "JHU-9X4K",
    category: "Club",
    membersCount: 12,
    ...
    members: [
      {
        ...
        major: "IT Junior",
        status: "on_campus",
        currentBuilding: "Keyser Quadrangle / MSE Library & Brody Learning Commons",
        ...
        timeline: [
          ...
          { time: "11:45 AM – 1:00 PM", location: "Hopkins Student Center Food Court", activity: "Lunch at Chick-fil-A", icon: "🍕", duration: "1h 15m" },
          { time: "1:15 PM – Present", location: "MSE Library & Brody Learning Commons Ground Floor", activity: "Studying & Capstone Research", icon: "📚", duration: "Active" },
        ],
        breadcrumbTrail: [
      ...
      },
      {
        ...
        major: "CS Senior",
        status: "studying",
        currentBuilding: "Brody Learning Commons & Milton S. Eisenhower Library",
        ...
        timeline: [
          { time: "8:45 AM", location: "Blue Jay Square Quad", activity: "Departed Residence Hall", icon: "🏠", duration: "10m" },
          { time: "9:00 AM – 11:30 AM", location: "Brody Learning Commons & Milton S. Eisenhower Library SC 304", activity: "Operating Systems Lab", icon: "🔬", duration: "2h 30m" },
          { time: "11:45 AM – 12:30 PM", location: "Hopkins Student Center Starbucks", activity: "Coffee Break with Study Pod", icon: "☕", duration: "45m" },
          { time: "12:45 PM – Present", location: "Brody Learning Commons & Milton S. Eisenhower Library 3rd Floor", activity: "Algorithms Study Session", icon: "💻", duration: "Active" },
        ],
        breadcrumbTrail: [
      ...
      },
      {
        ...
        major: "Info Systems",
        status: "on_campus",
        currentBuilding: "Hopkins Student Center",
        ...
        timeline: [
          ...
          { time: "10:00 AM – 12:00 PM", location: "Mergenthaler Hall Rm 102", activity: "Business Info Tech Class", icon: "🏛️", duration: "2h" },
          { time: "12:15 PM – Present", location: "Hopkins Student Center 2nd Floor", activity: "Lunch & SGA Project Meeting", icon: "🍕", duration: "Active" },
        ],
        breadcrumbTrail: [
      ...
      },
      {
        ...
        major: "CS Senior",
        status: "studying",
        currentBuilding: "MSE Library & Brody Learning Commons",
        currentFloor: "2nd Floor",
        ...
        timeline: [
          { time: "10:00 AM", location: "JHU Residential Towers", activity: "Walked to Quad", icon: "🚶", duration: "12m" },
          { time: "10:30 AM – 1:00 PM", location: "Center for the Arts", activity: "Digital Audio Synthesis Studio", icon: "🎭", duration: "2h 30m" },
          { time: "1:15 PM – Present", location: "MSE Library & Brody Learning Commons 2nd Floor Pod B", activity: "Cybersecurity Capture the Flag Prep", icon: "🛡️", duration: "Active" },
        ],
        breadcrumbTrail: [
  ...
  },
  {
    ...
    members: [
      ...
      },
      {
        ...
        currentFloor: "33rd Street & University Pkwy Northbound",
        ...
        timeline: [
          { time: "11:00 AM", location: "Malone Hall & Hackerman Hall (Computer Science & Robotics) (CBE)", activity: "Finance Midterm Exam", icon: "🏛️", duration: "1h 30m" },
          { time: "1:00 PM", location: "Ralph S. O'Connor Center for Recreation & Well-Being (PAC) Gym", activity: "Weight Training Session", icon: "🏋️", duration: "1h" },
          { time: "2:15 PM – Present", location: "Driving on North Charles Street (MD-139)", activity: "Headed home to Apt 304", icon: "🚗", duration: "Active", speedMph: 24 },
        ],
      },
    ],
  },
    ...
    members: [
      {
        ...
        major: "IT Junior",
        status: "on_campus",
        currentBuilding: "MSE Library & Brody Learning Commons Pod B",
        currentFloor: "2nd Floor",
        exactRoom: "Pod B-12",
        distanceFt: 0,
        x: 48,
...
export const initialHopkinsShuttles: HopkinsShuttle[] = [
  {
    id: "shuttle-gold",
    routeName: "Gold Route (Campus Loop)",
    routeColor: "#f59e0b",
    busNumber: "Blue Jay Bus #14",
    nextStop: "Hopkins Student Center Transit Plaza",
    etaMinutes: 2,
  ...
  {
    id: "shuttle-black",
    routeName: "Black Route (Johns Hopkins University Town Center)",
    routeColor: "#0f172a",
    busNumber: "Blue Jay Bus #08",
    nextStop: "MSE Library & Brody Learning Commons North Stop",
    etaMinutes: 5,
  ...
  {
    id: "shuttle-west",
    routeName: "Blue Jay Square Express",
    routeColor: "#6366f1",
    busNumber: "Blue Jay Bus #22",
    nextStop: "Blue Jay Square Commons",
    etaMinutes: 8,
    occupancyStatus: "Seats Available",
...
// 5. Johns Hopkins University Parking Garages
export const initialHopkinsParking: HopkinsParkingGarage[] = [
  {
    id: "pkg-union",
    name: "Blue Jay Square Garage (Levels 1-6)",
    code: "UNION-GARAGE",
    totalSpaces: 1200,
    openSpaces: 184,
    status: "Available",
  ...
  {
    id: "pkg-hopkinstown",
    name: "Johns Hopkins Universitytown Garage",
    code: "SAN-MARTIN-GARAGE",
    totalSpaces: 950,
    openSpaces: 42,
    status: "Limited",
...
// 6. Johns Hopkins University (JHU) Safety Mode Beacons (JHUPD Blue Lights & SafeWalk)
export const initialHopkinsSafetyBeacons: SafetyBeacon[] = [
  {
    id: "saf-blue-1",
    name: "Blue Light Phone #104 (Keyser Quadrangle)",
    type: "Blue Light Phone",
    locationDescription: "Between MSE Library & Brody Learning Commons & Lecture Hall Plaza",
    x: 46,
    y: 46,
    distanceFt: 90,
    status: "Operational",
  ...
  },
  {
    ...
    type: "Blue Light Phone",
    locationDescription: "Brody Learning Commons & Milton S. Eisenhower Library South Atrium Plaza",
    x: 60,
    y: 38,
    distanceFt: 380,
    status: "Operational",
  ...
  },
  {
    ...
    type: "Blue Light Phone",
    locationDescription: "Connecting Hopkins Student Center to Blue Jay Square Garage",
    x: 36,
    y: 60,
    distanceFt: 340,
    status: "Operational",
  ...
  {
    id: "saf-jhupd",
    name: "Johns Hopkins University (JHU) Police HQ (JHUPD)",
    type: "Police HQ",
    locationDescription: "JHUPD Headquarters · 24/7 Dispatch Center",
    x: 82,
    y: 18,
    distanceFt: 840,
...
// 7. Blue Jay Pride Map Scavenger & Treasure Hunt (Game Checkpoints)
export const initialHopkinsScavengerCheckpoints: ScavengerHuntCheckpoint[] = [
  {
    id: "chk-1",
    title: "1. The Historic Johns Hopkins University Blue Jay Statue",
    clue: "Seek the bronze mascot guarding Keyser Quadrangle where students gather before classes.",
    landmark: "Keyser Quadrangle (Bronze Blue Jay Statue)",
    points: 250,
    x: 48,
    y: 47,
    qrCodeToken: "JHU-BLUEJAY-BLUE-2026",
    isVisited: true,
    badgeReward: "🐾 Blue Jay Pride Pioneer",
  },
  {
    id: "chk-2",
    title: "2. The Brody Learning Commons & Milton S. Eisenhower Library Rooftop Planetarium",
    clue: "Look toward the stars from the top of TU's newest 320,000 sq ft research beacon.",
    landmark: "Brody Learning Commons & Milton S. Eisenhower Library (Planetarium Dome)",
    points: 300,
    x: 62,
    y: 36,
    qrCodeToken: "JHU-SCI-PLANET-44",
    isVisited: false,
    badgeReward: "🔭 Quantum Explorer",
  },
  {
    id: "chk-3",
    title: "3. Ralph S. O'Connor Center for Recreation & Well-Being (PAC) 30-Foot Climbing Wall",
    clue: "Find the towering indoor peak inside campus recreation.",
    landmark: "Ralph S. O'Connor Center for Recreation & Well-Being (PAC) Rec Center",
    points: 250,
    x: 28,
    y: 68,
    qrCodeToken: "JHU-OCONNOR-REC-PEAK-09",
    isVisited: false,
    badgeReward: "🧗 Summit Champion",
  },
  {
    id: "chk-4",
    title: "4. Step to the Clock Tower at Malone Hall & Hackerman Hall (Computer Science & Robotics)",
    clue: "The historic brick facade and clock tower that has chimed for generations of Blue Jays.",
    landmark: "Malone Hall & Hackerman Hall (Computer Science & Robotics) Clock Tower",
    points: 350,
    x: 54,
    y: 52,
    qrCodeToken: "JHU-CLOCK-1866",
    isVisited: false,
    badgeReward: "🏆 Master Campus Explorer",
  },
];

// 8. Turn-by-Turn Navigation Steps (Johns Hopkins University Route Simulator)
export const sampleHopkinsRoute: NavigationStep[] = [
  {
    stepNumber: 1,
    instruction: "Start at Keyser Quadrangle (Blue Jay Statue)",
    detail: "Head Northeast along the paved University Mall path towards Brody Learning Commons & Milton S. Eisenhower Library.",
    icon: "walk",
    distanceFt: 180,
  },
  {
  ...
  {
    stepNumber: 3,
    instruction: "Enter Brody Learning Commons & Milton S. Eisenhower Library via South Atrium",
...
export const initialCampusReels: CampusReel[] = [
  {
    id: "reel-1",
    title: "Autonomous battlebot arena test run in Johns Hopkins University Brody Learning Commons & Milton S. Eisenhower Library Lab 304! 🤖🔥",
    creatorName: "Johns Hopkins University Robotics Society",
    ...
    audioTrack: "Original Sound — SU Brody Learning Commons & Milton S. Eisenhower Library",
    duration: "0:28",
    likesCount: 2450,
    isLiked: false,
    commentsCount: 183,
  ...
  {
    id: "reel-2",
    title: "Simulated penetration test demo on our Johns Hopkins University containerized honeypot cluster 🛡️💻",
    creatorName: "Johns Hopkins University Cybersecurity Club",
    ...
    audioTrack: "Cyber Beats — JHU Cyber Defense",
    duration: "0:42",
    likesCount: 1820,
    isLiked: true,
    commentsCount: 94,
  ...
  {
    id: "reel-3",
    title: "Cultural Night dance rehearsal sneak peek at Hopkins Student Center Ballroom! 🎉🌍",
    creatorName: "African Student Association",
    creatorHandle: "@ASA_Johns Hopkins University",
    ...
    audioTrack: "Afrobeats Fusion — JHU Festival Mix",
    duration: "0:35",
    likesCount: 3100,
    isLiked: false,
    commentsCount: 240,
...
// 10. Johns Hopkins University Trivia Challenge
export const initialCampusGames: CampusGame[] = [
  {
    id: "game-hopkins-cyber",
    title: "Johns Hopkins University Blue Jay Tech & Cyber Challenge",
    category: "Trivia",
    description: "5 rapid-fire questions on Johns Hopkins University campus tech, network defense, and MSE Library & Brody Learning Commons systems. Earn points for the semester leaderboard!",
    icon: "🐯",
    highScore: 9420,
    ...
    questions: [
      {
        id: "q1",
        question: "Which building houses the Cybersecurity & CIS Labs at Johns Hopkins University (JHU)?",
        options: ["Devilbiss Hall", "East Baltimore Medical Campus (JHH & Bloomberg) & Brody Learning Commons & Milton S. Eisenhower Library", "Ralph S. O'Connor Center for Recreation & Well-Being (PAC)", "Malone Hall & Hackerman Hall (Computer Science & Robotics)"],
        correctIndex: 1,
        explanation: "East Baltimore Medical Campus (JHH & Bloomberg) and the new Brody Learning Commons & Milton S. Eisenhower Library house TU's premier cybersecurity and CIS labs.",
      },
      {
        id: "q2",
        question: "What is the emergency phone number for Johns Hopkins University (JHU) Police (JHUPD)?",
        options: ["(410) 704-4444", "911 only", "(555) 019-9111", "(410) 555-0100"],
        correctIndex: 0,
        explanation: "JHUPD 24/7 Emergency Dispatch is reachable at (410) 704-4444 and via any campus Blue Light phone.",
      },
      {
        id: "q3",
        question: "Where are the 24/7 quiet study pods located during midterms at Johns Hopkins University?",
        options: ["Hopkins Student Center Food Court", "Milton S. Eisenhower Library & Brody Learning Commons (MSE Library) Floors 2-3", "Blue Jay Stadium", "South Garage (Wyman Park)"],
        correctIndex: 1,
        explanation: "MSE Library & Brody Learning Commons floors remain open 24/7 for midterm and finals study sessions.",
      },
      {
        id: "q4",
        question: "What is the primary shuttle loop connecting Blue Jay Square to Hopkins Student Center?",
        options: ["Gold Route (Campus Loop)", "Green Line", "Silver Metro", "Purple Connector"],
        correctIndex: 0,
        explanation: "The Gold Route provides continuous loops connecting Union, Blue Jay Square, and Blue Jay Stadium.",
      },
      {
        id: "q5",
        question: "What is the bronze mascot landmark located at Keyser Quadrangle?",
        options: ["Bronze Eagle", "Johns Hopkins University Blue Jay", "Golden Bear", "Black Hawk"],
        correctIndex: 1,
        explanation: "The iconic bronze Johns Hopkins University Blue Jay statue stands proudly at Keyser Quadrangle outside MSE Library & Brody Learning Commons.",
      },
    ],
    leaderboard: [
...
// 11. Initial Johns Hopkins University Notifications
export const initialCampusNotifications: CampusNotification[] = [
  {
    id: "notif-1",
    type: "EVENT",
    title: "AI Security Keynote in SU Brody Learning Commons & Milton S. Eisenhower Library",
    body: "Dr. Marcus Vance's keynote in Brody Learning Commons & Milton S. Eisenhower Library Auditorium starts at 5:00 PM. Your QR pass is ready.",
    timeAgo: "20m ago",
    isRead: false,
    actionUrl: "events",
  },
  {
    ...
    body: "Amara Diallo posted: Cultural Night rehearsal schedule at Hopkins Student Center Ballroom is set!",
    timeAgo: "1h ago",
    isRead: false,
  ...
  },
  {
    ...
    body: "Maya Chen is currently in Brody Learning Commons & Milton S. Eisenhower Library Rm 304.",
    timeAgo: "2m ago",
    isRead: false,
    actionUrl: "campus",
  },
...
// 13. Initial Live Activities (🔴 LIVE AT Hopkins UNIVERSITY)
export const initialLiveActivities: LiveCampusActivity[] = [
  {
    id: "live-1",
    title: "Johns Hopkins University Blue Jays Basketball vs Delaware",
    location: "Blue Jay Stadium",
    attendeesCount: 3200,
    category: "Sports",
    statusText: "4th Quarter • Blue Jays up by 4 (68-64)",
    icon: "🏀",
    linkTab: "events",
  },
  {
  ...
  },
  {
    ...
    location: "Hopkins Student Center North Loading Dock",
    attendeesCount: 31,
...
export const initialPeerMatches: PeerMatch[] = [
  {
    ...
    sharedReason: "Both enrolled in CMSC 421 and members of Johns Hopkins University Cybersecurity Club",
    isConnected: false,
  },
  {
    id: "peer-2",
    ...
    sharedReason: "Both interested in Cloud & frequent Ralph S. O'Connor Center for Recreation & Well-Being (PAC) gym",
    isConnected: true,
  },
];
...
export const initialQuickGroups: QuickGroup[] = [
  {
    id: "qg-1",
    name: "JHU AI Hackathon Autonomous Defense Team",
...
export const initialCampusOpportunities: CampusOpportunity[] = [
  {
    ...
    type: "Paid Research",
    departmentOrOrg: "JHU Autonomous Cyber Lab (ASSL)",
  ...
  {
    id: "opp-2",
    title: "Johns Hopkins University $10,000 Blue Jay Innovation Hackathon Prize",
    type: "Hackathon",
    departmentOrOrg: "Fisher College of Science and Mathematics",
    rewardOrPay: "$10,000 Prize Pool",
    deadline: "Apr 04, 2026",
    description: "48-hour campus hackathon in Brody Learning Commons & Milton S. Eisenhower Library with tracks in AI, Cybersecurity, and HealthTech.",
...
export const initialServiceRequests: CampusServiceRequest[] = [
  {
    ...
    location: "MSE Library & Brody Learning Commons 2nd Floor Pod B",
    description: "High packet loss and dropouts on Hopkins-Secure Wi-Fi SSID near Pod B.",
    status: "In Progress",
...
export const initialEventMemories: EventMemory[] = [
  {
    ...
    photosCount: 426,
    aiGeneratedRecap:
      "Over 184 students converged in the Hopkins Student Center for 12 hours of rapid prototyping. 32 completed projects were demoed across autonomous security, campus sustainability, and accessible transit. Team 'CyberPulse' took first place with their automated honeypot mesh.",
...
export const initialOfficeHours: OfficeHourSlot[] = [
  {
    ...
    officeLocation: "Brody Learning Commons & Milton S. Eisenhower Library Rm 314",
...
export const initialCampusPosts: CampusPost[] = [
  {
    ...
    scope: "CAMPUS_WIDE",
    location: "Hopkins Student Center Ballroom",
    content:
      "🎉 Cultural Night is this Friday at 7:00 PM in the Hopkins Student Center! Experience live music, authentic African cuisines, cultural fashion runway, and student dance performances. Free admission for all Johns Hopkins University students!",
  ...
  },
  {
    id: "p2",
    authorId: "club-cs",
    authorName: "Johns Hopkins University Cybersecurity Club",
    ...
    clubName: "Johns Hopkins University Cybersecurity Club",
    scope: "CLUB",
    location: "Brody Learning Commons & Milton S. Eisenhower Library Rm 304",
    content:
      "📚 Hands-on AI Workshop tomorrow at 5:00 PM in Brody Learning Commons & Milton S. Eisenhower Library Rm 304! We will build LLM agent workflows and explore cybersecurity defense loops. 35 students already attending. Bring your laptops!",
...
export const initialCampusEvents: CampusEvent[] = [
  {
    ...
    clubName: "Johns Hopkins University Cybersecurity Club & CIS Dept",
    category: "Guest Speaker",
    location: "Brody Learning Commons & Milton S. Eisenhower Library Auditorium (SC-101)",
    buildingCode: "SC-101",
    dateMonth: "MAR",
    dateDay: "03",
    ...
    attendeesCount: 184,
    userRsvp: "GOING",
    ticketPrice: "Free with JCard",
    ticketStatus: "Available",
    tags: ["Cybersecurity", "AI Agents", "NSA CAE-CD", "Keynote", "Networking"],
    weatherRequirement: "Indoor",
    ticketCode: "JHU-TKT-8492-CYBER",
    gateEntrance: "Brody Learning Commons & Milton S. Eisenhower Library North Lobby Entrance",
    recommendationReason: "Recommended because you follow Cybersecurity Club & attend CIS events",
    description: "Distinguished guest lecture on autonomous loop defense systems, agentic offensive testing, and generative security models in the Brody Learning Commons & Milton S. Eisenhower Library Auditorium.",
    speakers: [
      ...
      { name: "Maya Chen", title: "JHU Cyber Club President & NSA Cyber Scholar", avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80" }
    ],
    agenda: [
  ...
  {
    id: "ev-2",
    title: "CAA Men's Basketball: Johns Hopkins University Blue Jays vs. Delaware Blue Hens (Gold Rush Game)",
    clubName: "Johns Hopkins University Athletics & Doc's Army",
    category: "Athletics",
    location: "Blue Jay Stadium Main Court",
    ...
    attendeesCount: 4180,
    userRsvp: "GOING",
    ticketPrice: "Free for All JHU Students",
    ticketStatus: "Selling Fast",
    tags: ["Basketball", "Division-I", "CAA", "Gold Rush", "Doc's Army", "Free T-Shirts"],
    weatherRequirement: "Indoor",
    ticketCode: "JHU-TKT-9912-HOOPS",
    gateEntrance: "Blue Jay Stadium Gate 1 (Student Section Pass)",
    recommendationReason: "Rivalry Gold Rush Game — Free Gold T-Shirts to first 1,500 students in Doc's Army section!",
    description: "The Johns Hopkins University Blue Jays host the Delaware Blue Hens in a pivotal CAA regular season showdown. Wear Gold! Concessions discounts and halftime student half-court shot for $10,000 tuition.",
    speakers: [
      { name: "Pat Skerry", title: "Johns Hopkins University Men's Basketball Head Coach", avatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80" }
    ],
    agenda: [
      { time: "5:30 PM", topic: "Doc's Army Pre-Game Student Tailgate (Free Pizza & Face Painting)" },
      { time: "6:15 PM", topic: "Blue Jay Stadium Student Gates Open" },
      { time: "7:00 PM", topic: "Tip-Off: Johns Hopkins University Blue Jays vs. Delaware" },
  ...
  {
    id: "ev-3",
    title: "Blue JayHacks 2026: 24-Hour Autonomous AI & Web3 Hackathon",
    clubName: "WiCS, Cyber Club & Major League Hacking",
    category: "Hackathon",
    location: "Brody Learning Commons & Milton S. Eisenhower Library & East Baltimore Medical Campus (JHH & Bloomberg)",
    buildingCode: "SC-304",
    dateMonth: "MAR",
    dateDay: "14",
    ...
    weatherRequirement: "Indoor",
    ticketCode: "JHU-TKT-3304-HACKS",
    gateEntrance: "Brody Learning Commons & Milton S. Eisenhower Library Center Atrium",
    recommendationReason: "$15,000 in sponsor prize bounties from Google Cloud, Northrop Grumman & T. Rowe Price!",
    description: "Johns Hopkins University (JHU)'s flagship annual 24-hour hackathon. Build software, AI agents, mobile apps, or hardware hacks with mentors, free meals, Red Bull stations, and recruiting booths.",
    speakers: [
      ...
      { name: "Devon Brooks", title: "VP of Technology, Johns Hopkins University Software Guild", avatar: "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=150&auto=format&fit=crop&q=80" }
    ],
    agenda: [
  ...
  {
    id: "ev-4",
    title: "Blue Jayfest 2026: Spring Music Festival, Carnival & Concert",
    clubName: "Campus Activities Board (CAB)",
    category: "Concert",
    location: "Blue Jay Stadium Lawn & Hopkins Student Center Beach",
    ...
    ticketStatus: "Selling Fast",
    tags: ["Blue Jayfest", "Concert", "Carnival", "Food Trucks", "Tradition", "Spring"],
    weatherRequirement: "Outdoor",
    ticketCode: "JHU-TKT-7714-TFEST",
    gateEntrance: "Blue Jay Stadium Lawn South Entrance (ID Check)",
    recommendationReason: "Johns Hopkins University's biggest tradition of the year! Live national headliners, ferris wheel, carnival games, and 12 local Baltimore & Charles Village food trucks.",
    ...
    agenda: [
      ...
      { time: "9:45 PM", topic: "Grand Finale Fireworks Show over Homewood Field Turf" }
    ],
  ...
  },
  {
    ...
    clubName: "Johns Hopkins University (JHU) Career Center",
    category: "Career Fair",
    location: "Blue Jay Stadium Concourse & Arena Floor",
    ...
    weatherRequirement: "Indoor",
    ticketCode: "JHU-TKT-1102-FAIR",
    gateEntrance: "Blue Jay Stadium Main Concourse Entrance",
    ...
    speakers: [
      { name: "David Henderson", title: "Director of Employer Relations, Life Design Lab @ Imagine Center", avatar: "https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=150&auto=format&fit=crop&q=80" }
    ],
    agenda: [
  ...
  },
  {
    ...
    location: "Hopkins Student Center Ballrooms (UU-300)",
    buildingCode: "UU-300",
    dateMonth: "MAR",
    dateDay: "27",
    ...
    weatherRequirement: "Indoor",
    ticketCode: "JHU-TKT-5512-GALA",
    gateEntrance: "Hopkins Student Center 3rd Floor Ballroom Entrance",
    recommendationReason: "Johns Hopkins University's most celebrated cultural formal! Features traditional 3-course dinner, runway fashion show, and live Afrobeats orchestra.",
  ...
  {
    id: "ev-7",
    title: "NCAA Women's Lacrosse: Johns Hopkins University Blue Jays vs. Drexel Dragons (Senior Night)",
    clubName: "Johns Hopkins University Athletics",
    category: "Athletics",
    location: "Johnny Blue Jay Stadium",
    ...
    attendeesCount: 1850,
    userRsvp: "INTERESTED",
    ticketPrice: "Free with Student JCard",
    ticketStatus: "Available",
    tags: ["Lacrosse", "Division-I", "Senior Night", "CAA", "Blue Jays"],
    weatherRequirement: "Outdoor",
    ticketCode: "JHU-TKT-6601-LAX",
    gateEntrance: "Blue Jay Stadium West Gate",
    recommendationReason: "Senior Night under the lights! Free Johns Hopkins University Lacrosse bucket hats to first 500 students.",
    description: "Cheer on the nationally ranked Johns Hopkins University Blue Jays Women's Lacrosse team in their premier CAA conference match against rival Drexel.",
    speakers: [
      { name: "Kristen Carr", title: "Johns Hopkins University Women's Lacrosse Head Coach", avatar: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150&auto=format&fit=crop&q=80" }
    ],
    agenda: [
      { time: "5:30 PM", topic: "Senior Class Player Ceremony & Family Tribute" },
      { time: "6:00 PM", topic: "Opening Faceoff: Johns Hopkins University vs. Drexel" },
  ...
  },
  {
    ...
    clubName: "Johns Hopkins University Investment Group (TIG)",
    category: "Academic",
    location: "Malone Hall & Hackerman Hall (Computer Science & Robotics) Trading Room (SH-212)",
    buildingCode: "SH-212",
    dateMonth: "MAR",
    dateDay: "25",
    ...
    weatherRequirement: "Indoor",
    ticketCode: "JHU-TKT-9911-TIG",
    gateEntrance: "Malone Hall & Hackerman Hall (Computer Science & Robotics) 2nd Floor Trading Suite",
    ...
    speakers: [
      { name: "Zachary Cohen", title: "Portfolio Manager, Johns Hopkins University Investment Group", avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80" },
  ...
  },
  {
    ...
    clubName: "Campus Activities Board (CAB)",
    category: "Tradition",
    location: "Hopkins Student Center Amphitheater & Lawn",
  ...
  },
  {
    ...
    category: "Cultural Festival",
    location: "Potomac Lounge (Hopkins Student Center)",
...
export const initialCampusClubs: CampusClub[] = [
  {
    ...
    description: "Celebrating African heritage, fostering student unity, community service, and academic excellence at Johns Hopkins University (JHU).",
    logo: "🌍",
    ...
    aboutText: "The African Student Association provides a welcoming, empowering space for cultural exchange, alumni mentorship, academic excellence, and philanthropic initiatives across the greater Baltimore community & Charles Village.",
    meetingTime: "Thursdays @ 6:00 PM",
    meetingLocation: "Hopkins Student Center Rm 320",
    foundedYear: 1994,
    tags: ["Cultural", "Pan-African", "Mentorship", "Community Service", "Gala"],
    contactEmail: "asa@hopkins.edu",
    instagram: "@hopkins_asa",
    discordUrl: "https://discord.gg/hopkins-asa",
    dues: "$15 / Semester",
    sgaBudget: 6800,
    council: "SGA",
    status: "Featured",
    ...
    projects: [
      { id: "p1", title: "Pan-African Library Book Drive", description: "Collecting 500 STEM and literature textbooks for local Baltimore youth STEM & robotics centers.", status: "In Progress", lead: "Amara Diallo" },
  ...
  },
  {
    ...
    aboutText: "We prepare JHU students for top-tier careers in cyber defense, malware analysis, cloud security, and ethical hacking through hands-on virtual cyber range challenges and industry guest speakers.",
    meetingTime: "Wednesdays @ 5:30 PM",
    meetingLocation: "Brody Learning Commons & Milton S. Eisenhower Library Rm 304 & Cyber Range",
    foundedYear: 2012,
    tags: ["Cybersecurity", "CTF", "CCDC", "Ethical Hacking", "NSA CAE-CD"],
    contactEmail: "cybersec@hopkins.edu",
    instagram: "@hopkinscyber",
    discordUrl: "https://discord.gg/hopkins-cyber",
    dues: "$0 / Free for all JHU students",
    sgaBudget: 12500,
    ...
    documents: [
      { id: "d3", name: "JHU Cyber Lab Safety & Ethics Agreement.pdf", type: "PDF", size: "450 KB", url: "#" },
  ...
  },
  {
    ...
    aboutText: "Founded in 1969, the Johns Hopkins University BSU empowers students through social activism, career development, community service, and cultural solidarity.",
    meetingTime: "Tuesdays @ 6:30 PM",
    meetingLocation: "Hopkins Student Center Ballroom West",
    foundedYear: 1969,
    tags: ["Cultural", "Advocacy", "Leadership", "Black History", "Networking"],
    contactEmail: "bsu@hopkins.edu",
    instagram: "@hopkinsbsu",
    discordUrl: "https://discord.gg/hopkins-bsu",
    dues: "$10 / Year",
    sgaBudget: 14000,
    council: "SGA",
    status: "Featured",
    ...
    projects: [
      { id: "p5", title: "Black Alumni Mentorship Pipeline", description: "Matching 100 undergraduates with JHU alumni in Fortune 500 & government sectors.", status: "In Progress", lead: "Destiny Taylor" },
  ...
  },
  {
    ...
    nextEvent: "AI & Full-Stack Web Development Bootcamp (Sat 11 AM @ Malone Hall Rm 320)",
    ...
    meetingLocation: "East Baltimore Medical Campus (JHH & Bloomberg) Rm 425",
    foundedYear: 2016,
    tags: ["STEM", "Coding", "Diversity in Tech", "Grace Hopper", "Mentorship"],
    contactEmail: "wics@hopkins.edu",
    instagram: "@hopkins_wics",
    discordUrl: "https://discord.gg/hopkins-wics",
    dues: "$0 / Free",
    sgaBudget: 8500,
    council: "Academic Senate",
    status: "Active",
  ...
  },
  {
    ...
    description: "The primary representative governing body for 20,000+ JHU undergraduate students, overseeing policy, campus initiatives, and student org allocations.",
    logo: "🏛️",
    ...
    meetingLocation: "Hopkins Student Center Senate Chambers (Rm 324)",
    foundedYear: 1921,
    tags: ["Governance", "Student Advocacy", "Legislation", "Appropriations", "Leadership"],
    contactEmail: "sga@hopkins.edu",
    instagram: "@hopkins_sga",
    discordUrl: "https://discord.gg/hopkins-sga",
  ...
  {
    id: "org-tig",
    name: "Johns Hopkins University Investment Group (TIG)",
    category: "Professional",
    membersCount: 175,
    isJoined: false,
    president: "Zachary Cohen (Senior, Finance)",
    description: "Undergraduate student-managed investment fund actively managing $250,000 of JHU endowment assets across equities, fixed income, and REITs.",
    logo: "📈",
    banner: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&auto=format&fit=crop&q=80",
    nextEvent: "Stock Pitch & Sector Pitch Deck Reviews (Wednesday 7 PM @ Malone Hall & Hackerman Hall (Computer Science & Robotics))",
    ...
    meetingLocation: "Malone Hall & Hackerman Hall (Computer Science & Robotics) Rm 212 (Trading Room)",
    foundedYear: 2005,
    tags: ["Finance", "Investing", "Wall Street", "Bloomberg", "Equity Research"],
    contactEmail: "tig@hopkins.edu",
    instagram: "@hopkinsinvestmentgroup",
    discordUrl: "https://discord.gg/hopkins-tig",
    dues: "$20 / Semester",
    sgaBudget: 9200,
  ...
  },
  {
    ...
    nextEvent: "Black & Gold Informational & Stroll Showcase (Friday 7 PM @ Blue Jay Square)",
    aboutText: "Chartered at Johns Hopkins University (JHU) on January 15, 1971, the Eta Zeta chapter develops leaders, promotes brotherhood and academic excellence, while providing service and advocacy for our communities.",
    meetingTime: "Sundays @ 5:00 PM",
    meetingLocation: "Hopkins Student Center Multipurpose Rm",
    foundedYear: 1971,
    tags: ["Greek Life", "NPHC", "Divine Nine", "Brotherhood", "Philanthropy", "Leadership"],
    contactEmail: "etazeta1906@hopkins.edu",
    instagram: "@hopkins_alphas",
    discordUrl: "#",
    dues: "$120 / Semester",
    sgaBudget: 4200,
    council: "NPHC",
  ...
  },
  {
    ...
    aboutText: "Chartered at Johns Hopkins University (JHU) in 1973, Lambda Beta focuses on Educational Development, Economic Development, International Awareness, Physical and Mental Health, and Political Awareness & Involvement.",
    meetingTime: "Sundays @ 6:30 PM",
    meetingLocation: "Hopkins Student Center Rm 204",
    foundedYear: 1973,
    tags: ["Greek Life", "NPHC", "Divine Nine", "Sisterhood", "Public Service"],
    contactEmail: "lambdabeta_dst@hopkins.edu",
    instagram: "@hopkins_deltas",
    discordUrl: "#",
    dues: "$125 / Semester",
    sgaBudget: 4500,
    council: "NPHC",
  ...
  },
  {
    ...
    description: "Fostering cultural pride, community advocacy, and academic support for Latinx/Hispanic students and allies across Johns Hopkins University (JHU).",
    logo: "💃🏽",
    ...
    meetingLocation: "Hopkins Student Center Rm 314",
    foundedYear: 1988,
    tags: ["Cultural", "Latinx", "Dance", "Advocacy", "Bilingual", "Socials"],
    contactEmail: "laso@hopkins.edu",
    instagram: "@hopkins_laso",
    discordUrl: "https://discord.gg/hopkins-laso",
    dues: "$10 / Year",
    sgaBudget: 5500,
    council: "SGA",
    status: "Active",
  ...
  {
    id: "org-esports",
    name: "Johns Hopkins University Blue Jays Esports & Gaming",
    category: "Sports",
    membersCount: 340,
    isJoined: true,
    ...
    nextEvent: "Super Smash Bros Ultimate LAN Tournament (Friday 6 PM @ O'Connor Recreation Center Rm 110)",
    aboutText: "We host competitive scrims in the Mattin Center Gaming Suite, compete in NACE Starleague, and hold open game nights with VR setups, consoles, and PC rigs.",
    meetingTime: "Fridays @ 6:00 PM",
    meetingLocation: "Ralph S. O'Connor Center for Recreation & Well-Being (PAC) Esports Arena & Lounge",
    foundedYear: 2017,
    tags: ["Esports", "Gaming", "Valorant", "Smash Bros", "LAN", "Twitch"],
    contactEmail: "esports@hopkins.edu",
    instagram: "@tuesports",
    discordUrl: "https://discord.gg/hopkins-esports",
    dues: "$0 / Free",
    sgaBudget: 11000,
    council: "Club Sports",
    status: "Featured",
    ...
    documents: [
      { id: "d13", name: "Mattin Center Gaming Suite Rules & Hardware Guide.pdf", type: "PDF", size: "1.1 MB", url: "#" }
    ],
  },
  {
    id: "org-towerlight",
    ...
    description: "The independent student news organization serving the Johns Hopkins University (JHU) community since 1921 with award-winning investigative journalism.",
    logo: "📰",
    ...
    meetingLocation: "Hopkins Student Center Media Suite Rm 208",
    foundedYear: 1921,
  ...
  },
  {
    ...
    nextEvent: "Johns Hopkins & Hopkins Med Student Panel (Wednesday 6 PM @ Devilbiss Hall)",
    ...
    contactEmail: "premed@hopkins.edu",
    instagram: "@hopkins_premed",
    discordUrl: "https://discord.gg/hopkins-premed",
    dues: "$15 / Year",
    sgaBudget: 6200,
    council: "Academic Senate",
    status: "Active",
  ...
  },
  {
    ...
    description: "The premier student-run programming board responsible for major campus concerts, Homecoming, Blue Jayfest, comedians, and outdoor movies.",
    logo: "🎪",
    banner: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=800&auto=format&fit=crop&q=80",
    nextEvent: "Blue Jayfest Spring Music Festival Artist Reveal (Friday 12 PM @ Beach)",
    ...
    meetingLocation: "Hopkins Student Center CAB Suite",
    foundedYear: 1968,
    tags: ["Events", "Concerts", "Blue Jayfest", "Homecoming", "Entertainment"],
    contactEmail: "cab@hopkins.edu",
    instagram: "@hopkinscab",
    discordUrl: "#",
    dues: "$0 / Student Fee Funded",
    sgaBudget: 380000,
    council: "SGA",
    ...
    projects: [
      { id: "p18", title: "Blue Jayfest 2026 Headliner Production", description: "Planning outdoor stadium stage, security, and food truck concourse for 6,000 attendees.", status: "In Progress", lead: "Brianna Jenkins" }
    ],
    documents: [
  ...
  {
    id: "org-ama",
    name: "American Marketing Association (AMA Johns Hopkins University)",
    category: "Professional",
    membersCount: 120,
    isJoined: false,
    ...
    aboutText: "AMA Johns Hopkins University is an affiliated collegiate chapter of the American Marketing Association providing certified training in Google Analytics, HubSpot, and SEO.",
    meetingTime: "Thursdays @ 5:00 PM",
    meetingLocation: "Malone Hall & Hackerman Hall (Computer Science & Robotics) Rm 110",
    foundedYear: 1978,
    tags: ["Marketing", "Branding", "Social Media", "Advertising", "SEO"],
    contactEmail: "amahopkins@gmail.com",
    instagram: "@amahopkins",
    discordUrl: "#",
    ...
    projects: [
      { id: "p19", title: "Johns Hopkins University Local Business Re-Branding Challenge", description: "Student marketing teams designing digital advertising packages for 5 local restaurants.", status: "In Progress", lead: "Lucas Meyers" }
    ],
    documents: [
  ...
  {
    id: "org-glen",
    name: "Environmental Action & Stony Run Greenway & Wyman Park Dell Guardians",
    category: "Volunteer",
    membersCount: 130,
    isJoined: true,
    president: "Cora Sterling (Junior, Environmental Science)",
    description: "Protecting Johns Hopkins University's 12-acre Stony Run Greenway & Wyman Park Dell forest ecosystem, native species restoration, and campus sustainability initiatives.",
    logo: "🌲",
    banner: "https://images.unsplash.com/photo-1448375240586-882707db888b?w=800&auto=format&fit=crop&q=80",
    nextEvent: "Wyman Park Dell Nature Grove Restoration & Native Tree Planting (Saturday 10 AM @ Wyman Park Dell Nature Grove Pavilion)",
    aboutText: "We maintain nature trails, eliminate invasive English ivy, monitor Johns Hopkins University Run stream water quality, and champion university zero-waste compost goals.",
    meetingTime: "Bi-Weekly Saturdays @ 10:00 AM",
    meetingLocation: "Stony Run Greenway & Wyman Park Dell Forest Pavilion",
    foundedYear: 2001,
    tags: ["Environment", "Sustainability", "Forestry", "Conservation", "Volunteer"],
    contactEmail: "environment@hopkins.edu",
    instagram: "@hopkins_green",
    discordUrl: "https://discord.gg/hopkins-green",
    dues: "$0 / Free",
    sgaBudget: 4900,
    council: "SGA",
    status: "Active",
    ...
    projects: [
      { id: "p20", title: "Johns Hopkins University Run Native Wetland Buffer Zone", description: "Planting 250 native ferns and red maple saplings to prevent stormwater runoff erosion.", status: "In Progress", lead: "Cora Sterling" }
    ],
    documents: [
      { id: "d18", name: "Stony Run Greenway & Wyman Park Dell Flora & Fauna Field Guide.pdf", type: "PDF", size: "3.9 MB", url: "#" }
    ],
  },
  {
    id: "org-akpsi",
    ...
    nextEvent: "Spring Professional Rush & Case Competition (Wednesday 7 PM @ Gilman Hall)",
...
export const initialVolunteerActivities: VolunteerActivity[] = [
  {
    ...
    category: "Food Drive",
    organizer: "Johns Hopkins University Student Community Service Council & FoodShare",
    organizerAvatar: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80",
    location: "Hopkins Student Center North Loading Dock & Food Hub",
  ...
  {
    id: "vol-2",
    title: "Stony Run Greenway & Wyman Park Dell Native Species Restoration & Trail Cleanup",
    category: "Campus Cleanup",
    organizer: "JHU Environmental Alliance & Stony Run Greenway & Wyman Park Dell Board",
    organizerAvatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80",
    location: "Stony Run Greenway & Wyman Park Dell Trailhead (Near Mergenthaler Hall)",
    date: "Sunday, Mar 09 • 10:00 AM - 1:30 PM",
    description: "Removing invasive English ivy and multiflora rose while planting 120 Maryland native saplings across the 12-acre Stony Run Greenway & Wyman Park Dell forest sanctuary.",
    progressPercent: 80,
    ...
    tasks: [
      ...
      "Collect and catalog recyclable litter along Stony Run Creek",
    ],
    status: "Recruiting",
    roles: [
  ...
  },
  {
    ...
    organizer: "Johns Hopkins University Cybersecurity Club & Baltimore City Schools",
    organizerAvatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80",
    location: "Brody Learning Commons & Milton S. Eisenhower Library Computer Lab SC-314",
  ...
  },
  {
    ...
    category: "Community Service",
    organizer: "Johns Hopkins University Pre-Veterinary Society & MD SPCA",
    organizerAvatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&auto=format&fit=crop&q=80",
    location: "Kenilworth Rescue Center & JHU Campus Quad",
  ...
  },
  {
    ...
    category: "Community Service",
    organizer: "SGA Student Outreach & Johns Hopkins University Senior Center",
    organizerAvatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80",
    location: "Johns Hopkins University Senior Center (Washington Ave)",
  ...
  },
  {
    ...
    category: "Fundraiser",
    organizer: "JHU Pre-Med Association & Red Cross Greater Chesapeake",
    organizerAvatar: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=150&auto=format&fit=crop&q=80",
    location: "Ralph S. O'Connor Center for Recreation & Well-Being (PAC) Multipurpose Activity Gym",
  ...
  {
    id: "vol-7",
    title: "Johns Hopkins University Community Clean-Up & 33rd Street & University Pkwy Corridor Spruce",
    category: "Campus Cleanup",
    organizer: "Johns Hopkins University Town & Gown Student Civic Coalition",
    organizerAvatar: "https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=150&auto=format&fit=crop&q=80",
    location: "South Campus Gateway & 33rd Street & University Pkwy Sidewalks",
    date: "Sunday, Mar 16 • 9:30 AM - 12:30 PM",
    description: "Beautifying pedestrian avenues connecting campus to Downtown Johns Hopkins University with street sweeping, flower bed mulching, and graffiti removal.",
    progressPercent: 85,
  ...
  },
  {
    ...
    category: "Community Service",
    organizer: "Johns Hopkins University College of Education Outreach",
    organizerAvatar: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150&auto=format&fit=crop&q=80",
    location: "Johns Hopkins University Elementary Partner School (Free Shuttle Provided)",
...
export const initialResearchProjects: ResearchOpportunity[] = [
  {
    ...
    labName: "Autonomous Security & Systems Lab (Brody Learning Commons & Milton S. Eisenhower Library Rm 314)",
    openingsGrad: 2,
    openingsUndergrad: 1,
...
export const initialCampusJobs: CampusJob[] = [
  {
    id: "job-1",
    title: "MSE Library & Brody Learning Commons Student Technology Assistant",
    department: "Milton S. Eisenhower Library & Brody Learning Commons (MSE Library) · Tech Desk",
    type: "Student Assistant",
    payRate: "$16.50 / hr",
    hoursPerWeek: "12-15 hrs/week",
    location: "MSE Library & Brody Learning Commons 1st Floor",
...
export const initialStudyPods: CourseStudyPod[] = [
  {
    ...
    roomLocation: "Milton S. Eisenhower Library & Brody Learning Commons (MSE Library) 2nd Floor, Pod B",
...
export const initialCampusCourses: CampusCourse[] = [
  {
    ...
    credits: 4.0,
    grade: "A (94%)",
    room: "Brody Learning Commons & Milton S. Eisenhower Library 204",
  ...
  },
  {
    ...
    credits: 3.0,
    grade: "A (96%)",
    room: "East Baltimore Medical Campus (JHH & Bloomberg) Rm 314",
  ...
  },
  {
    ...
    credits: 3.0,
    grade: "A- (91%)",
    room: "Brody Learning Commons & Milton S. Eisenhower Library 118",
...
export const initialCampusMedia: CampusMediaItem[] = [
  {
    ...
    channelName: "Johns Hopkins University CIS Department",
    channelLogo: "🛡️",
    ...
    description: "Dr. Marcus Vance (DARPA Lab) presents autonomous loop defense systems, live containment architectures, and AI vulnerability analysis at the Brody Learning Commons & Milton S. Eisenhower Library.",
...
export const initialCampusPolls: CampusPoll[] = [
  {
    ...
    organizer: "Johns Hopkins University Student Government Association (SGA)",
    scope: "Campus Wide",
    totalVotes: 842,
    userVotedOptionId: "opt-1",
    options: [
      { id: "opt-1", text: "A. Student Events & Cultural Festivals @ Union", votes: 380 },
      { id: "opt-2", text: "B. O'Connor Recreation Center & Fitness Suites Upgrades", votes: 190 },
      { id: "opt-3", text: "C. MSE Library & Brody Learning Commons Quiet Pod Tech Displays", votes: 172 },
...
export const initialChatMessages: ChatMessage[] = [
  {
    ...
    sender: "Johns Hopkins University Student Affairs",
    avatar: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80",
    text: "📢 Reminder: Spring Career Fair at Blue Jay Stadium registration closes Friday at 5:00 PM. 120+ employers attending.",
    time: "2:00 PM",
    isMe: false,
    createdAt: new Date().toISOString(),
  },
...
// ─────────────────────────────────────────────────────────────
// 31. HOPKINSHOUSING DOMAIN MODELS & HOPD DATASETS
// ─────────────────────────────────────────────────────────────
...
export const initialHousingListings: HousingListing[] = [
  {
    id: "hse-1",
    title: "University Village Johns Hopkins University — 2BR Renovated Suite",
    propertyType: "Apartment",
    address: "201 E Joppa Rd, Johns Hopkins University, MD 21286",
    neighborhood: "Johns Hopkins University Town Center District",
    monthlyRent: 925,
    ...
    shuttleRouteName: "Blue Jay Bus Gold Route #14",
    ...
    landlordName: "Johns Hopkins University Village Residential Mgmt",
    landlordContact: "(410) 825-4490",
    roomsAvailable: 1,
    mapCoords: { x: 55, y: 22 },
    isSaved: true,
    description: "Modern student apartment with individual leases, private bathroom per room, study lounge, and direct stop for the Johns Hopkins University Gold Shuttle.",
  },
  {
    id: "hse-2",
    title: "The Quarters at Johns Hopkins University Town Center — 4BR Shared House",
    propertyType: "Shared House",
    address: "8600 LaSalle Rd, Johns Hopkins University, MD 21286",
    ...
    shuttleRouteName: "JHMI Blue Line Shuttle #1",
    ...
    landlordName: "David Sterling (Verified Verified Hopkins Alum Owner)",
    landlordContact: "(410) 555-0192",
    roomsAvailable: 2,
    mapCoords: { x: 72, y: 18 },
    isSaved: false,
    description: "Spacious colonial student house with hard-wood floors, high-speed fiber internet, and quiet residential neighborhood 1 mile from MSE Library & Brody Learning Commons.",
  },
  {
    id: "hse-3",
    title: "Altus Johns Hopkins University Row — Modern Studio Suite",
    propertyType: "Apartment",
    address: "109 E Chesapeake Ave, Johns Hopkins University, MD 21286",
    neighborhood: "Downtown Johns Hopkins University Hub",
    monthlyRent: 1150,
    ...
    shuttleRouteName: "Blue Jay Bus Downtown Line",
    ...
    landlordName: "Johns Hopkins University Row Properties",
    landlordContact: "(410) 704-8800",
    roomsAvailable: 1,
    mapCoords: { x: 42, y: 15 },
    isSaved: false,
    description: "Luxury off-campus student high-rise right above Whole Foods and Target in Downtown Johns Hopkins University. 10-minute walk to Keyser Quadrangle.",
  },
];
...
export const initialRoommateProfiles: RoommateProfile[] = [
  {
    ...
    bio: "CS sophomore looking for 1 or 2 roommates for a 2-4BR apartment near Johns Hopkins University Town Center. Quiet during weeknights, into gaming and gym on weekends.",
    preferredLocations: ["University Village", "Johns Hopkins University Row", "The Quarters"],
    isConnected: false,
  },
  {
    id: "rm-2",
    ...
    compatibilityTags: ["✓ Match on Quiet Hours", "✓ Target Move-in August", "✓ Verified JHU Student"],
    bio: "JHU Nursing junior with clinical rotations. Need a respectful, peaceful place to study and recharge.",
    preferredLocations: ["Altus Johns Hopkins University Row", "Cardiff Hall Apts"],
    isConnected: false,
  },
];
...
export const initialHousingTours: HousingTourBooking[] = [
  {
    id: "tour-1",
    propertyId: "hse-1",
    propertyTitle: "University Village Johns Hopkins University — 2BR Renovated Suite",
    propertyAddress: "201 E Joppa Rd, Johns Hopkins University, MD",
...
// ─────────────────────────────────────────────────────────────
// 32. DIGITAL JCARD WALLET & DINING DOLLARS
// ─────────────────────────────────────────────────────────────
export interface JCardPass {
  studentName: string;
  studentId: string;
  major: string;
  classStanding: string;
...
export const initialJCardPass: JCardPass = {
  ...
  dormAccessZone: "Blue Jay Square • Marshall Hall Suite 304",
  barcodeNumber: "2849201948201",
  lastUsedTime: "Today at 12:45 PM",
  lastUsedLocation: "Blue Jay Square Grill (1 Swipe)",
};
...
export const initialFacilityDensities: LiveFacilityDensity[] = [
  {
    id: "fac-1",
    facilityName: "Milton S. Eisenhower Library & Brody Learning Commons (MSE Library)",
  ...
  {
    id: "fac-2",
    facilityName: "Ralph S. O'Connor Center for Recreation & Well-Being (PAC) Fitness Center",
  ...
  {
    id: "fac-3",
    facilityName: "Hopkins Student Center Food Court",
    zoneName: "Daily Grind Cafe (Brody) & Main Seating Atrium",
    occupancyPercent: 45,
  ...
  {
    id: "fac-4",
    facilityName: "Brody Learning Commons & Milton S. Eisenhower Library Commons",
...
// ─────────────────────────────────────────────────────────────
// 34. HOPKINS NIGHT RIDE SAFEWALK — VIRTUAL NIGHT ESCORT
// ─────────────────────────────────────────────────────────────
...
export const initialSafeWalkSession: SafeWalkSession = {
  id: "sw-1",
  originName: "Milton S. Eisenhower Library & Brody Learning Commons (MSE Library)",
  destinationName: "Blue Jay Square • Marshall Hall",
  estimatedMinutes: 8,
...
// ─────────────────────────────────────────────────────────────
// 35. Hopkins ALUMNI MENTORSHIP & CAREER SYNC
// ─────────────────────────────────────────────────────────────
...
export const initialAlumniMentors: AlumniMentor[] = [
  {
    ...
    bio: "Former Johns Hopkins University Cybersecurity Club president. Passionate about helping JHU undergraduates break into cloud zero-trust and enblue jayrise threat hunting.",
  ...
  },
  {
    ...
    bio: "JHU IT alumna mentoring underrepresented students in AI-driven vulnerability management and DoD cATO compliance.",
    isAvailableForCoffeeChat: true,
  ...
  },
  {
    ...
    bio: "Johns Hopkins University Hackathon winner now building agentic cloud pipelines. Offering resume reviews and mock technical interviews.",
    isAvailableForCoffeeChat: true,
...
// ─────────────────────────────────────────────────────────────
// 36. HOPKINSSYNC IDENTITY PERSONAS & ROLE-BASED ACCESS CONTROL (RBAC)
// ─────────────────────────────────────────────────────────────
...
export const initialCampusPersonas: UserProfile[] = [
  {
    id: "usr-1",
    name: "Kwesi Asiedu",
    email: "kasiedu@students.hopkins.edu",
    studentId: "#8492-KWESI",
    major: "Information Technology",
    minor: "Cybersecurity & Autonomous Systems",
    gradYear: 2026,
    classStanding: "Senior",
    dormBuilding: "Marshall Hall (Blue Jay Square)",
    ...
    goals: ["Present Research at CyberSummit 2026", "Complete Senior Capstone", "Lead HackJohns Hopkins University"],
    eventsAttendedCount: 28,
    volunteerHoursLogged: 42.5,
    leadershipRoles: ["SGA Tech Chair", "Cybersecurity Club Vice President"],
    achievements: ["Dean's List 5x", "Johns Hopkins University Innovator Grant 2025", "Certified Blue Jay Leader"],
    projects: ["Johns Hopkins UniversitySync Platform", "AXIOM Zero-Trust Suite", "Campus Beacon Map"],
    isLocationSharing: true,
    ghostModeEnabled: false,
    currentLocationName: "Milton S. Eisenhower Library & Brody Learning Commons (MSE Library) • 3rd Floor",
  },
  {
    id: "usr-2",
    name: "Dr. Catherine Hayes",
    email: "chayes@hopkins.edu",
    studentId: "#FAC-2091",
    major: "Faculty / Computer Science",
    minor: "Director, ASSL Research Lab",
    gradYear: 2012,
    classStanding: "Graduate",
    dormBuilding: "Faculty Commons • Brody Learning Commons & Milton S. Eisenhower Library",
    bio: "Associate Professor of Computer & Information Sciences. Principal Investigator for the Johns Hopkins University Autonomous Security Systems Lab.",
    ...
    achievements: ["Johns Hopkins University Excellence in Teaching 2024", "NSF Career Award"],
    projects: ["Autonomous Threat Mitigation", "Secure Microkernel Architecture"],
    isLocationSharing: true,
    ghostModeEnabled: false,
    currentLocationName: "Brody Learning Commons & Milton S. Eisenhower Library Rm 304",
  },
  {
    id: "usr-3",
    name: "Darren Vance",
    email: "dvance2@students.hopkins.edu",
    studentId: "#8210-DARREN",
    major: "Cybersecurity Operations",
    gradYear: 2026,
    classStanding: "Senior",
    dormBuilding: "Carroll Hall",
    bio: "Johns Hopkins University Cybersecurity Club President & SGA Senator. Passionate about collegiate cyber defense competitions and student advocacy.",
    avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&auto=format&fit=crop&q=80",
    coverImage: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&auto=format&fit=crop&q=80",
    isVerified: true,
    role: "CLUB_LEAD",
    interests: ["Red Teaming", "CTF Competitions", "Student Orgs", "Campus Radio"],
    goals: ["Qualify for National CCDC", "Host 500-student Blue JayCTF"],
    ...
    projects: ["Blue JayCTF Cyber Range", "Student Discord Bot"],
    isLocationSharing: true,
    ghostModeEnabled: false,
    currentLocationName: "Hopkins Student Center Food Court",
  },
  {
    id: "usr-4",
    name: "Dean Marcus Vance",
    email: "mvance@hopkins.edu",
    studentId: "#ADM-001",
    ...
    bio: "Executive Administrator for Johns Hopkins University (JHU) Digital Campus Operations, Emergency Preparedness & Student Life Systems.",
    ...
    goals: ["Achieve 100% Digital Johns Hopkins UniversitySync Campus Coverage", "Zero Safety Incident Tolerance"],
    ...
    achievements: ["State of Maryland Higher Ed Leadership Medal", "JHUPD Commendation"],
    projects: ["Johns Hopkins UniversitySync Master Campus Mesh", "Blue Light Digital Beacon Network"],
    isLocationSharing: false,
...
// ─────────────────────────────────────────────────────────────
// 37. HOPKINSSYNC ADMINISTRATION CENTER DATASETS
// ─────────────────────────────────────────────────────────────
...
export const initialAdminVerifications: AdminVerificationRequest[] = [
  {
    ...
    email: "avance5@students.hopkins.edu",
  ...
  {
    id: "ver-3",
    applicantName: "Johns Hopkins University Robotics & Autonomous Drone Club",
    email: "robotics@clubs.hopkins.edu",
  ...
  {
    id: "ver-4",
    applicantName: "The York Johns Hopkins University Student Residences",
    email: "leasing@theyorkhopkins.com",
...
export interface AdminSecurityAuditLog {
  id: string;
  timestamp: string;
  eventType: "AUTH_LOGIN" | "ROLE_ELEVATION" | "SAFEWALK_ALERT" | "CONTENT_MODERATION" | "ID_VERIFICATION" | "JHUPD_DISPATCH";
...
export const initialAdminAuditLogs: AdminSecurityAuditLog[] = [
  {
    ...
    details: "SafeWalk escort initiated: MSE Library & Brody Learning Commons ➔ Bradford Apartments & AMR I (Companion: Maya Chen)",
  ...
  },
  {
    ...
    details: "Duo MFA 2-Factor Authentication verified successfully from Brody Learning Commons & Milton S. Eisenhower Library Lab",
  ...
  },
  {
    ...
    eventType: "JHUPD_DISPATCH",
    severity: "INFO",
    actor: "Blue JayOrbit Blue Light #04",
...
export const initialAdminSystemHealth: AdminSystemHealth = {
  ...
  uptimePercent: 99.98,
  jhuBeaconHealth: "24/24 Blue Light Beacons Operational",
