...
export const defaultCurrentUser: UserProfile = {
  ...
  currentLocationName: "McKeldin Mall & Testudo Plaza (Near McKeldin Library (Terrapin Learning Commons))",
};
...
export const initialUmdBuildings: UmdBuilding[] = [
  ...
  {
    id: "bld-mckeldin",
    name: "Albert S. McKeldin Library (Terrapin Learning Commons)",
    code: "MCK-24",
    shortCode: "MCK",
    category: "Library",
  ...
  },
  {
    ...
    description: "Heart of campus life featuring Chick-fil-A, Footnotes Cafe (McKeldin), Chesapeake Roasting Co., SGA Senate Chamber, student organization offices, and Terrapin Esports Arena.",
    x: 38,
    y: 58,
    distanceFt: 350,
  ...
  },
  {
    ...
    studySpacesCount: 18,
    classroomsCount: 24,
    accessibleEntrance: "Main Campus Drive & Regents Dr Entrance (East Ramp)",
    floorsCount: 3,
...
export const initialUmdPlaces: CirclePlaceAlert[] = [
  {
    id: "place-library",
    placeName: "Albert S. McKeldin Library (Terrapin Learning Commons)",
    icon: "📚",
    radiusMeters: 100,
  ...
  {
    id: "place-union",
    placeName: "Adele H. Stamp Student Union",
    icon: "🍕",
    radiusMeters: 120,
    ...
    members: [
      {
        ...
        major: "IT Junior",
        status: "on_campus",
        currentBuilding: "McKeldin Mall & Testudo Plaza / McKeldin Library (Terrapin Learning Commons)",
        ...
        timeline: [
          ...
          { time: "11:45 AM – 1:00 PM", location: "Adele H. Stamp Student Union Food Court", activity: "Lunch at Chick-fil-A", icon: "🍕", duration: "1h 15m" },
          { time: "1:15 PM – Present", location: "McKeldin Library (Terrapin Learning Commons) Ground Floor", activity: "Studying & Capstone Research", icon: "📚", duration: "Active" },
        ],
        breadcrumbTrail: [
      ...
      },
      {
        ...
        timeline: [
          ...
          { time: "11:45 AM – 12:30 PM", location: "Adele H. Stamp Student Union Starbucks", activity: "Coffee Break with Study Pod", icon: "☕", duration: "45m" },
      ...
      },
      {
        ...
        major: "Info Systems",
        status: "on_campus",
        currentBuilding: "Adele H. Stamp Student Union",
        ...
        timeline: [
          ...
          { time: "12:15 PM – Present", location: "Adele H. Stamp Student Union 2nd Floor", activity: "Lunch & SGA Project Meeting", icon: "🍕", duration: "Active" },
        ],
        breadcrumbTrail: [
      ...
      },
      {
        ...
        major: "CS Senior",
        status: "studying",
        currentBuilding: "McKeldin Library (Terrapin Learning Commons)",
        currentFloor: "2nd Floor",
        ...
        timeline: [
          ...
          { time: "1:15 PM – Present", location: "McKeldin Library (Terrapin Learning Commons) 2nd Floor Pod B", activity: "Cybersecurity Capture the Flag Prep", icon: "🛡️", duration: "Active" },
        ],
        breadcrumbTrail: [
  ...
  },
  {
    ...
    members: [
      ...
      },
      {
        ...
        currentFloor: "Campus Drive & Regents Dr Northbound",
        ...
        timeline: [
          ...
          { time: "2:15 PM – Present", location: "Driving on Baltimore Avenue (US-1)", activity: "Headed home to Apt 304", icon: "🚗", duration: "Active", speedMph: 24 },
        ],
      },
    ],
  },
    ...
    members: [
      {
        ...
        major: "IT Junior",
        status: "on_campus",
        currentBuilding: "McKeldin Library (Terrapin Learning Commons) Pod B",
        currentFloor: "2nd Floor",
        exactRoom: "Pod B-12",
        distanceFt: 0,
        x: 48,
...
export const initialUmdShuttles: UmdShuttle[] = [
  {
    ...
    nextStop: "Adele H. Stamp Student Union Transit Plaza",
    etaMinutes: 2,
  ...
  },
  {
    ...
    nextStop: "McKeldin Library (Terrapin Learning Commons) North Stop",
    etaMinutes: 5,
...
export const initialUmdSafetyBeacons: SafetyBeacon[] = [
  {
    id: "saf-blue-1",
    name: "Blue Light Phone #104 (McKeldin Mall & Testudo Plaza)",
    type: "Blue Light Phone",
    locationDescription: "Between McKeldin Library (Terrapin Learning Commons) & Lecture Hall Plaza",
    x: 46,
    y: 46,
    distanceFt: 90,
    status: "Operational",
  ...
  },
  {
    ...
    type: "Blue Light Phone",
    locationDescription: "Connecting Adele H. Stamp Student Union to Terrapin Square Garage",
    x: 36,
    y: 60,
    distanceFt: 340,
    status: "Operational",
...
export const initialUmdScavengerCheckpoints: ScavengerHuntCheckpoint[] = [
  {
    ...
    clue: "Seek the bronze mascot guarding McKeldin Mall & Testudo Plaza where students gather before classes.",
    landmark: "McKeldin Mall & Testudo Plaza (Bronze Terrapin Statue)",
    points: 250,
    x: 48,
    y: 47,
...
export const sampleUmdRoute: NavigationStep[] = [
  {
    stepNumber: 1,
    instruction: "Start at McKeldin Mall & Testudo Plaza (Terrapin Statue)",
...
export const initialCampusReels: CampusReel[] = [
  ...
  {
    id: "reel-3",
    title: "Cultural Night dance rehearsal sneak peek at Adele H. Stamp Student Union Ballroom! 🎉🌍",
...
export const initialCampusGames: CampusGame[] = [
  {
    ...
    category: "Trivia",
    description: "5 rapid-fire questions on UMD College Park campus tech, network defense, and McKeldin Library (Terrapin Learning Commons) systems. Earn points for the semester leaderboard!",
    icon: "🐯",
    highScore: 9420,
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["Adele H. Stamp Student Union Food Court", "Albert S. McKeldin Library (Terrapin Learning Commons) Floors 2-3", "Terrapin Stadium", "Mowatt Lane Garage"],
        correctIndex: 1,
        explanation: "McKeldin Library (Terrapin Learning Commons) floors remain open 24/7 for midterm and finals study sessions.",
      },
      {
        id: "q4",
        question: "What is the primary shuttle loop connecting Terrapin Square to Adele H. Stamp Student Union?",
      ...
      {
        id: "q5",
        question: "What is the bronze mascot landmark located at McKeldin Mall & Testudo Plaza?",
        options: ["Bronze Eagle", "UMD College Park Terrapin", "Golden Bear", "Black Hawk"],
        correctIndex: 1,
        explanation: "The iconic bronze UMD College Park Terrapin statue stands proudly at McKeldin Mall & Testudo Plaza outside McKeldin Library (Terrapin Learning Commons).",
      },
    ],
    leaderboard: [
...
export const initialCampusNotifications: CampusNotification[] = [
  ...
  },
  {
    ...
    body: "Amara Diallo posted: Cultural Night rehearsal schedule at Adele H. Stamp Student Union Ballroom is set!",
    timeAgo: "1h ago",
    isRead: false,
...
export const initialLiveActivities: LiveCampusActivity[] = [
  ...
  },
  {
    ...
    location: "Adele H. Stamp Student Union North Loading Dock",
    attendeesCount: 31,
...
export const initialServiceRequests: CampusServiceRequest[] = [
  {
    ...
    location: "McKeldin Library (Terrapin Learning Commons) 2nd Floor Pod B",
...
export const initialEventMemories: EventMemory[] = [
  {
    ...
    photosCount: 426,
    aiGeneratedRecap:
      "Over 184 students converged in the Adele H. Stamp Student Union for 12 hours of rapid prototyping. 32 completed projects were demoed across autonomous security, campus sustainability, and accessible transit. Team 'CyberPulse' took first place with their automated honeypot mesh.",
...
export const initialCampusPosts: CampusPost[] = [
  {
    ...
    scope: "CAMPUS_WIDE",
    location: "Adele H. Stamp Student Union Ballroom",
    content:
      "🎉 Cultural Night is this Friday at 7:00 PM in the Adele H. Stamp Student Union! Experience live music, authentic African cuisines, cultural fashion runway, and student dance performances. Free admission for all UMD College Park students!",
...
export const initialCampusEvents: CampusEvent[] = [
  ...
  },
  {
    ...
    category: "Concert",
    location: "Terrapin Stadium Lawn & Adele H. Stamp Student Union Beach",
    ...
    recommendationReason: "UMD College Park's biggest tradition of the year! Live national headliners, ferris wheel, carnival games, and 12 local College Park & DMV food trucks.",
    ...
    agenda: [
      ...
      { time: "9:45 PM", topic: "Grand Finale Fireworks Show over SECU Stadium Turf Field" }
    ],
  ...
  },
  {
    ...
    location: "Adele H. Stamp Student Union Ballrooms (UU-300)",
    buildingCode: "UU-300",
    dateMonth: "MAR",
    dateDay: "27",
    ...
    gateEntrance: "Adele H. Stamp Student Union 3rd Floor Ballroom Entrance",
  ...
  },
  {
    ...
    clubName: "Campus Activities Board (CAB)",
    category: "Tradition",
    location: "Adele H. Stamp Student Union Amphitheater & Lawn",
  ...
  },
  {
    ...
    category: "Cultural Festival",
    location: "Potomac Lounge (Adele H. Stamp Student Union)",
...
export const initialCampusClubs: CampusClub[] = [
  {
    ...
    aboutText: "The African Student Association provides a welcoming, empowering space for cultural exchange, alumni mentorship, academic excellence, and philanthropic initiatives across the greater College Park and Prince George's County community.",
    meetingTime: "Thursdays @ 6:00 PM",
    meetingLocation: "Adele H. Stamp Student Union Rm 320",
    foundedYear: 1994,
    ...
    projects: [
      { id: "p1", title: "Pan-African Library Book Drive", description: "Collecting 500 STEM and literature textbooks for local Prince George's youth STEM outreach centers.", status: "In Progress", lead: "Amara Diallo" },
  ...
  },
  {
    ...
    meetingLocation: "Adele H. Stamp Student Union Ballroom West",
    foundedYear: 1969,
  ...
  },
  {
    ...
    nextEvent: "AI & Full-Stack Web Development Bootcamp (Sat 11 AM @ Brendan Iribe Center Rm 2107)",
  ...
  },
  {
    ...
    meetingLocation: "Adele H. Stamp Student Union Senate Chambers (Rm 324)",
    foundedYear: 1921,
  ...
  },
  {
    ...
    meetingLocation: "Adele H. Stamp Student Union Multipurpose Rm",
    foundedYear: 1971,
  ...
  },
  {
    ...
    meetingLocation: "Adele H. Stamp Student Union Rm 204",
    foundedYear: 1973,
  ...
  },
  {
    ...
    meetingLocation: "Adele H. Stamp Student Union Rm 314",
    foundedYear: 1988,
  ...
  },
  {
    ...
    meetingLocation: "Adele H. Stamp Student Union Media Suite Rm 208",
    foundedYear: 1921,
  ...
  },
  {
    ...
    meetingLocation: "Adele H. Stamp Student Union CAB Suite",
    foundedYear: 1968,
  ...
  {
    id: "org-glen",
    name: "Environmental Action & Paint Branch Trail & Stream Sanctuary Guardians",
    category: "Volunteer",
    membersCount: 130,
    isJoined: true,
    president: "Cora Sterling (Junior, Environmental Science)",
    description: "Protecting UMD College Park's 12-acre Paint Branch Trail & Stream Sanctuary forest ecosystem, native species restoration, and campus sustainability initiatives.",
    logo: "🌲",
    ...
    meetingLocation: "Paint Branch Trail & Stream Sanctuary Forest Pavilion",
    foundedYear: 2001,
    ...
    documents: [
      { id: "d18", name: "Paint Branch Trail & Stream Sanctuary Flora & Fauna Field Guide.pdf", type: "PDF", size: "3.9 MB", url: "#" }
    ],
  },
  {
    id: "org-akpsi",
...
export const initialVolunteerActivities: VolunteerActivity[] = [
  {
    ...
    location: "Adele H. Stamp Student Union North Loading Dock & Food Hub",
  ...
  {
    id: "vol-2",
    title: "Paint Branch Trail & Stream Sanctuary Native Species Restoration & Trail Cleanup",
    category: "Campus Cleanup",
    organizer: "UMD Environmental Alliance & Paint Branch Trail & Stream Sanctuary Board",
    organizerAvatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80",
    location: "Paint Branch Trail & Stream Sanctuary Trailhead (Near Tydings Hall)",
    date: "Sunday, Mar 09 • 10:00 AM - 1:30 PM",
    description: "Removing invasive English ivy and multiflora rose while planting 120 Maryland native saplings across the 12-acre Paint Branch Trail & Stream Sanctuary forest sanctuary.",
    progressPercent: 80,
  ...
  {
    id: "vol-7",
    title: "UMD College Park Community Clean-Up & Campus Drive & Regents Dr Corridor Spruce",
    category: "Campus Cleanup",
    ...
    location: "South Campus Gateway & Campus Drive & Regents Dr Sidewalks",
...
export const initialCampusJobs: CampusJob[] = [
  {
    id: "job-1",
    title: "McKeldin Library (Terrapin Learning Commons) Student Technology Assistant",
    department: "Albert S. McKeldin Library (Terrapin Learning Commons) · Tech Desk",
    type: "Student Assistant",
    payRate: "$16.50 / hr",
    hoursPerWeek: "12-15 hrs/week",
    location: "McKeldin Library (Terrapin Learning Commons) 1st Floor",
...
export const initialStudyPods: CourseStudyPod[] = [
  {
    ...
    roomLocation: "Albert S. McKeldin Library (Terrapin Learning Commons) 2nd Floor, Pod B",
...
export const initialCampusPolls: CampusPoll[] = [
  {
    ...
    options: [
      ...
      { id: "opt-3", text: "C. McKeldin Library (Terrapin Learning Commons) Quiet Pod Tech Displays", votes: 172 },
...
export const initialHousingListings: HousingListing[] = [
  ...
  },
  {
    ...
    mapCoords: { x: 72, y: 18 },
    isSaved: false,
    description: "Spacious colonial student house with hard-wood floors, high-speed fiber internet, and quiet residential neighborhood 1 mile from McKeldin Library (Terrapin Learning Commons).",
  },
  {
    id: "hse-3",
    ...
    mapCoords: { x: 42, y: 15 },
    isSaved: false,
    description: "Luxury off-campus student high-rise right above Whole Foods and Target in Downtown UMD College Park. 10-minute walk to McKeldin Mall & Testudo Plaza.",
  },
];
...
export const initialFacilityDensities: LiveFacilityDensity[] = [
  {
    id: "fac-1",
    facilityName: "Albert S. McKeldin Library (Terrapin Learning Commons)",
  ...
  {
    id: "fac-3",
    facilityName: "Adele H. Stamp Student Union Food Court",
    zoneName: "Footnotes Cafe (McKeldin) & Main Seating Atrium",
    occupancyPercent: 45,
...
export const initialSafeWalkSession: SafeWalkSession = {
  id: "sw-1",
  originName: "Albert S. McKeldin Library (Terrapin Learning Commons)",
...
export const initialCampusPersonas: UserProfile[] = [
  {
    ...
    ghostModeEnabled: false,
    currentLocationName: "Albert S. McKeldin Library (Terrapin Learning Commons) • 3rd Floor",
  },
  {
    id: "usr-2",
  ...
  },
  {
    ...
    isLocationSharing: true,
    ghostModeEnabled: false,
    currentLocationName: "Adele H. Stamp Student Union Food Court",
  },
  {
    id: "usr-4",
...
export const initialAdminAuditLogs: AdminSecurityAuditLog[] = [
  {
    ...
    details: "SafeWalk escort initiated: McKeldin Library (Terrapin Learning Commons) ➔ South Campus Commons & Courtyards (Companion: Maya Chen)",
...
export const initialAdminSystemHealth: AdminSystemHealth = {
  ...
  uptimePercent: 99.98,
  umpdBeaconHealth: "24/24 Blue Light Beacons Operational",
